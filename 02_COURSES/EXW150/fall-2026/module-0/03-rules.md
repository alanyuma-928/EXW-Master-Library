  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Dietary Guardrails
        </h2>
        <p style="font-weight: bold; color: #003366;">SSoT: 2025–2030 Dietary Guidelines for Americans</p>
    </header>

    <section id="nutritional-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Inventory Filter</h3>
        <p>Your fueling mission is governed by these "Rules" of evidentiary science:</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The DGA Mandate:</strong> The 2025–2030 Dietary Guidelines for Americans (DGA) serve as the primary source of truth. All nutritional claims must be validated against this federal standard.</li>
            <li><strong>The Nutrient Density Rule:</strong> Prioritize foods that provide the highest inventory of vitamins, minerals, and fiber per calorie. High volume does not always equal high value.</li>
            <li><strong>The Whole-Food Priority:</strong> Supplements are secondary to whole-food inventory. You cannot out-supplement a failing baseline diet.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Strategist Note:</strong> In this course, we do not follow "Fads." we follow <strong>Fluid Dynamics</strong> and <strong>Metabolic Math</strong>.
        </div>
    </section>
