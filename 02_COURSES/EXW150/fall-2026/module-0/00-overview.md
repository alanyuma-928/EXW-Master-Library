  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 0: Performance Nutrition Foundations
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Athlete as an Engine" Mission</p>
    </header>

    <section id="system-input">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Input = Output</h3>
        <p>
            Human performance is governed by a fundamental <strong>Pattern</strong>: the quality of your physiological output is limited by the quality of your nutritional input. In EXW150, we view the athlete as a high-performance engine that requires strategic resource management.
        </p>
        <p>
            By the end of this module, you will establish your <strong>Nutritional Baseline</strong>—learning to separate "Social Media Science" from the objective federal standards that govern evidence-based fueling.
        </p>
    </section>
