  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Metabolic Flux
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding the "Optimal Energy Availability"</p>
    </header>

    <section id="flux-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Architectural Filter</h3>
        <p>Your body composition mission is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Leucine Threshold Rule:</strong> To trigger muscle protein synthesis (Module 3), a single dose of protein must contain approximately 2.5–3.0g of the amino acid **Leucine**. This is the "Ignition Switch" for hypertrophy.</li>
            <li><strong>The Energy Availability Mandate (RED-S):</strong> Athletes must maintain a minimum energy availability (> 30 kcal/kg of FFM) to avoid Relative Energy Deficiency in Sport (RED-S). Falling below this redline triggers hormonal and metabolic failure.</li>
            <li><strong>The "Lean-Gain" Surplus Rule:</strong> Hypertrophy requires a caloric surplus, but to minimize fat gain, the "Rule" is a modest **250–500 kcal/day** increase paired with high-protein intake.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Pro Tip:</strong> You cannot "Accidentally" build muscle. It requires the synchronization of the <strong>Leucine Threshold</strong> and the <strong>Hypertrophy Surplus</strong>.
        </div>
    </section>
