  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 8: Weight Management (Body Architecture)
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Metabolic Flux" of Human Performance</p>
    </header>

    <section id="system-flux">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Body Architecture</h3>
        <p>
            Weight management for the athlete is a high-precision <strong>Pattern</strong> of caloric math and macronutrient timing. We shift from the "Additives" of Module 7 into the <strong>Architectural Math</strong> of Module 8.
        </p>
        <p>
            By the end of this module, you will master the <strong>Energy Availability Rules</strong>—learning how to solve for muscle gain (Hypertrophy) or fat loss while preserving your hard-won structural hardware.
        </p>
    </section>
