  ...
  <div class="module-content">
    ...
    <section id="submission-protocol">
        ...
        <ol>
            ...
            <li><strong>The Solve:</strong> Apply the <strong>Leucine Threshold Rule</strong>—identify one specific food source (e.g., Whey protein or Greek Yogurt) that clears the 2.5g leucine gate in a single sitting.</li>
        </ol>
    </section>
