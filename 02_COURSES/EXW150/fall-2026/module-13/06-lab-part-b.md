  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 13 - The Scope of Practice Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Boundary</p>
    </header>

    <section id="scope-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Boundary Solve</h3>
        <p>
            Your mission is to perform a **Jurisdictional Audit** of two different client requests.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario 1:</strong> A healthy athlete wants a plan to increase their lean mass for football season.
            <br>
            <strong>Scenario 2:</strong> A client asks for a specific "meal plan" to treat their newly diagnosed Type 2 Diabetes.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify which scenario represents "Healthy Performance Guidance" and which represents "Medical Nutrition Therapy (MNT)."</li>
            <li><strong>The Rule:</strong> Use the <strong>RD vs. Coach Gate</strong> to explain why a non-licensed practitioner must refer Scenario 2 to a specialist.</li>
            <li><strong>The Solve:</strong> If you are the coach in Scenario 1, what is the specific **NCCA-Accredited** certification you should pursue to clear the professional competence rule?</li>
        </ol>
    </section>
