  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 13: Ethics & Career Paths
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Credentialing Gate" of Nutrition</p>
    </header>

    <section id="system-professionalism">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Scope of Practice</h3>
        <p>
            The field of nutrition is a highly regulated <strong>Pattern</strong> of professional jurisdictions. Success in this industry requires a clear understanding of what you can and cannot do. We shift from the "Sociology" of Module 12 into the <strong>Professionalism</strong> of Module 13.
        </p>
        <p>
            By the end of this module, you will master the <strong>RD vs. Coach Gate</strong>—learning how to navigate your career path while respecting the legal and ethical redlines of the nutrition industry.
        </p>
    </section>
