  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 14: Tech & Personalized Nutrition
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Precision Nutrition" Pattern</p>
    </header>

    <section id="system-innovation">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Digital Resource Management</h3>
        <p>
            The future of performance nutrition is a high-velocity <strong>Pattern</strong> of precision: Continuous Glucose Monitors (CGMs), DNA-based fueling, and AI-driven meal planning. We shift from the "Ethics" of Module 13 into the <strong>Innovation</strong> of Module 14.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Data Privacy Rules</strong>—learning how to leverage technology to personalize fueling without losing the human clinical oversight of the "Centaur Coach."
        </p>
    </section>
