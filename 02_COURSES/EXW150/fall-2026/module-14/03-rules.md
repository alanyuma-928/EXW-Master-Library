  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Digital Handshake
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding the "Technological Integrator"</p>
    </header>

    <section id="innovation-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Frontier Filter</h3>
        <p>Your use of digital nutrition to move the mission forward is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Data Privacy Mandate (HIPAA 2.0):</strong> All digital logs, CGM data, and genomic profiles must be protected with healthcare-grade encryption. Privacy of the chemical inventory is a professional redline.</li>
            <li><strong>The Algorithm vs. Individual Rule:</strong> AI-generated plans are based on population datasets. The professional must use "Centaur Logic" to adjust the algorithm to the specific bioenergetic needs of the athlete (Module 10).</li>
            <li><strong>The Integrity Gate:</strong> Wearable tech (e.g., CGMs) provide "Estimations" of metabolic flux. They must be audited against the <strong>SSoT (DGA)</strong> to ensure they aren't leading to disordered behavior patterns (Module 9).</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Tech Logic:</strong> Technology provides the <strong>Data</strong>; the Mission Loop provides the <strong>Solve</strong>.
        </div>
    </section>
