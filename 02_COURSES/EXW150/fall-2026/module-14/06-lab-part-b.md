  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 14 - The Digital Fueling Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Digital Accuracy</p>
    </header>

    <section id="innovation-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Precision Solve</h3>
        <p>
            Your mission is to perform a **Digital Accuracy Audit** for a sample client using a CGM and an AI-Meal Planner.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> The AI proposes a "Zero-Carb" plan based on a momentary blood glucose spike recorded by the CGM during high-intensity training (Module 1).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify why "Zero-Carb" is an architectural failure for a high-intensity athlete (Refer to Module 1).</li>
            <li><strong>The Rule:</strong> Use the <strong>Algorithm vs. Individual Rule</strong> to explain why the AI's "Solve" is missing the bioenergetic context of the mission.</li>
            <li><strong>The Solve:</strong> How would a "Centaur Coach" use this data to adjust the <strong>Glycemic Response</strong> (Module 1) rather than deleting the carbs entirely?</li>
        </ol>
    </section>
