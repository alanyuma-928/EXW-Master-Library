  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Efficacy & Safety
        </h2>
        <p style="font-weight: bold; color: #000080;">**License:** CC BY-NC 4.0  
SSoT: WADA and NCAA Banned Substance Lists</p>
    </header>

    <section id="supplement-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Credibility Filter</h3>
        <p>Your use of ergogenic aids is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Supplement Hierarchy Rule:</strong> Food First, Supplements Last. A supplement is only a "Solve" after the Baseline Inventory (Module 0) and Timing Window (Module 6) are 100% optimized.</li>
            <li><strong>The Banned Substance Gate:</strong> Any additive must be audited against the current WADA (World Anti-Doping Agency) and NCAA prohibited lists. Ingestion of a banned substance, even accidental, is a mission-abort redline.</li>
            <li><strong>The Evidence Mandate:</strong> We only recognize supplements with Tier-1 clinical evidence for performance: Creatine Monohydrate (Power), Caffeine (Focus/Energy), and Beta-Alanine (Buffering).</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Professional Ethics:</strong> As a kinesiologist, your job is to guard the athlete's <strong>Eligibility</strong>. If a supplement is not 3rd-party tested (NSF/Informed Choice), it fails the safety audit.
        </div>
    </section>
