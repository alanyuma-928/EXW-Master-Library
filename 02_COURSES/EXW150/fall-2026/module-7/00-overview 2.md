  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 7: Ergogenic Aids & Supplements
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Force Multiplier" Pattern</p>
    </header>

    <section id="system-supplements">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Force Multipliers</h3>
        <p>
            In performance nutrition, supplements represent the final 1-2% of the mission. They are <strong>Force Multipliers</strong>—tools that can enhance a well-fueled engine but cannot fix a broken one. We shift from the "Macros" and "Micros" into the <strong>Specific Additives</strong> of Module 7.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Supplement Hierarchy Rule</strong>—learning how to identify safe, effective aids while avoiding the "Banned Substance Pattern" that leads to clinical or professional failure.
        </p>
    </section>
