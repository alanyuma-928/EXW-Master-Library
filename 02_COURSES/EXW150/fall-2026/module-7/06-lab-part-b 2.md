  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 07 - The Supplement Stack Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Eligibility</p>
    </header>

    <section id="stack-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Force Multiplier Solve</h3>
        <p>
            Your mission is to perform a **Security Audit** of a sample supplement stack.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> An AWC athlete is using a "Pre-Workout" blend that contains 400mg of Caffeine and several "Proprietary Blends" not listed on the NSF-Certified list.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the specific "Proprietary Blend" pattern. Why is this a danger for collegiate eligibility?</li>
            <li><strong>The Rule:</strong> Use the <strong>Banned Substance Gate</strong> to explain the risk of using non-NSF certified additives.</li>
            <li><strong>The Solve:</strong> Propose a "Safe Force Multiplier" alternative (e.g., plain caffeine or creatine monohydrate) that provides the efficacy without the eligibility risk.</li>
        </ol>
    </section>
