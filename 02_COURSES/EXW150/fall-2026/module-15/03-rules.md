  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Fulfillment Hierarchy
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Sustainability Audit" Rulebook</p>
    </header>

    <section id="synthesis-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Architect Filter</h3>
        <p>A comprehensive nutritional solve must satisfy the "Rules of Fulfillment":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Power-Hierarchy Rule:</strong> Inventory (Mods 1-3) must be established before Timing (Mod 6), and Timing must be established before Force Multipliers (Mod 7). You cannot out-supplement a broken baseline.</li>
            <li><strong>The Sustainability Audit:</strong> A blueprint is a "Logistical Failure" if the athlete cannot adhere to it. The plan must account for Social Factors (Mod 12) and Economic Realities of the Yuma community.</li>
            <li><strong>The SSoT Integrity Mandate:</strong> Every caloric and macronutrient target must be directly traceable to the <strong>DGA 2025–2030</strong> or <strong>ACSM Performance Standards</strong>.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Synthesis Logic:</strong> You are not just providing a "Meal Plan"; you are providing a <strong>Systemic Fueling Infrastructure</strong>.
        </div>
    </section>
