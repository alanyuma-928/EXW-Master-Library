  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 15: Course Capstone (Performance Nutrition Solve)
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Total Engine Synthesis" Pattern</p>
    </header>

    <section id="capstone-intro">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Target: Seasonal Integration</h3>
        <p>
            Welcome to the <strong>Final Mission</strong>. You have spent 14 modules deconstructing the nutritional inventory—from macronutrient velocity (Module 1) to digital precision (Module 14). Your final task is to <strong>Synthesize</strong> this knowledge into a single Season-Long Blueprint.
        </p>
        <p>
            In this capstone, you will act as a <strong>Performance Nutrition Architect</strong>. You will design a comprehensive fueling strategy for a specific AWC athlete, ensuring their engine is primed, sustained, and repaired across the entire competitive season.
        </p>
    </section>
