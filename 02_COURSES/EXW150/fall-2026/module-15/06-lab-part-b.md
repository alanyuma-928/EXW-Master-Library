  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 15 - The Season-Long Fueling Blueprint
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Performance Longevity</p>
    </header>

    <section id="capstone-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Final Synthesis</h3>
        <p>
            Your mission is to design a **High-Performance Fueling Blueprint** for a Matador athlete during their competitive season.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Athlete Profile:</strong> Select a specific Matador Athlete (e.g., Football, Baseball, Track). Identify their primary Bioenergetic Type (Power, Endurance, or Hybrid).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Define the total daily Inventory (Carbs, Protein, Fats) required to meet the <strong>Energy Availability Mandate</strong> (Module 8).</li>
            <li><strong>The Rule:</strong> Detail the <strong>Nutrient Timing Strategy</strong> (Pre-During-Post) for a game day vs. a rest day (Module 6).</li>
            <li><strong>The Solve:</strong> Propose one **Sustainability Adjustment** that accounts for a 50% reduction in budget or a move into a food desert (Module 12).</li>
        </ol>
    </section>
