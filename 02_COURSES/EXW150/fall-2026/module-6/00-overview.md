  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 6: Nutrient Timing (The Performance Window)
        </h2>
        <p style="font-weight: bold; color: #000080;">Synchronizing the Nutritional Mission</p>
    </header>

    <section id="system-timing">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Nutrient Timing</h3>
        <p>
            Success in performance nutrition is not just about <strong>What</strong> you eat, but <strong>When</strong> you eat it. The human engine operates in a discrete <strong>Pattern</strong> of three phases: Pre-Exercise (Priming), During-Exercise (Sustaining), and Post-Exercise (Recovering).
        </p>
        <p>
            By the end of this module, you will master the <strong>Phase-Specific Rules</strong>—learning how to synchronize your macros and hydration to maximize the outcome of every mission.
        </p>
    </section>
