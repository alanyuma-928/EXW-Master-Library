  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 06 - The Tri-Phase Mission Plan
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Performance Synchronization</p>
    </header>

    <section id="timing-plan">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Chrono-Solve</h3>
        <p>
            Your mission is to architect a **Tri-Phase Fueling Plan** for a 90-minute high-intensity soccer match in Yuma.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Athlete Profile:</strong> 70kg male, Matador Soccer. High sweat rate, prone to fatigue in the final 20 minutes.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the specific "Timing Window" for each phase (Pre, During, Post).</li>
            <li><strong>The Rule:</strong> Use the <strong>4:1 Recovery Mandate</strong> to calculate the specific grams of Carbs and Protein required for the post-mission window.</li>
            <li><strong>The Solve:</strong> Based on the 30-60g "During" rule, propose one specific liquid or gel inventory item that solves for the "Final 20-minute Fatigue Pattern."</li>
        </ol>
    </section>
