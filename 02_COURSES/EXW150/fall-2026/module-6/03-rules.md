  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Performance Phases
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding the "Nutritional Handshake"</p>
    </header>

    <section id="timing-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Chrono-Filter</h3>
        <p>Your fueling mission is divided into three "Rules" of phase-timing:</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Pre-Exercise Prime:</strong> Target 1-4g of Carbohydrate per kg of body weight 1-4 hours prior. Focus on <strong>Glycemic Integrity</strong> (Module 1) to ensure blood sugar stability.</li>
            <li><strong>The "During" Sustain:</strong> For missions > 60 minutes, target 30-60g of exogenous carbohydrate per hour + electrolytes (Module 5) to spare endogenous glycogen.</li>
            <li><strong>The 4:1 Recovery Mandate:</strong> Post-exercise, the body enters a primary "Anabolic Window." Target a 4:1 Ratio (4g Carbohydrate to 1g Protein) within 45 minutes to maximize glycogen resynthesis and hardware repair (Module 3).</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Recovery Logic:</strong> The <strong>Post-Exercise Mandate</strong> is the most critical rule for multi-mission days (e.g., AWC double-header matches).
        </div>
    </section>
