  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 16: The Nutritional Portfolio & Professional Audit
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Nutritional Architect" Exit Mission</p>
    </header>

    <section id="system-transition">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Final Gate: Professional Evolution</h3>
        <p>
            You have completed the mastery of the performance nutrition inventory. Module 16 marks the <strong>Exit Gate</strong>, where you shift from a "Learner" to a <strong>Nutritional Strategist</strong>.
        </p>
        <p>
            The objective of this final task is to migrate your "Nutritional Solves" from this semester—your blueprints, audits, and substrate plans—into a <strong>Professional Portfolio</strong> that will serve as your digital credentials for the kinesiology industry.
        </p>
    </section>
