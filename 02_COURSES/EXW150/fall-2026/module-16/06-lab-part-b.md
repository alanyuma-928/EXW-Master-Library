  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 16 - The Nutritional Identity Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Transition</p>
    </header>

    <section id="identity-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Fueling Philosophy Solve</h3>
        <p>
            Your mission is to perform a **Nutritional Identity Audit** to close out the EXW150 mission.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Prepare your nutritional artifacts for migration to your AWC Professional Portfolio.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the three most significant "Nutritional Solves" you produced this semester.</li>
            <li><strong>The Rule:</strong> Use the <strong>Scope Integrity Rule</strong> to explain why your Module 15 Blueprint is a "Performance Plan" and not "Medical Nutrition Therapy."</li>
            <li><strong>The Solve:</strong> Write a 200-word "Fueling Philosophy" statement. How over the semester have you integrated the **DGA 2025-2030 Rules** with the cultural and economic realities of the Yuma community?</li>
        </ol>
    </section>
