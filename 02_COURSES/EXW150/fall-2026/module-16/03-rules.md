...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <section id="portfolio-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Exit Filter</h3>
        <p>To successfully clear the nutritional foundations gate, your transition must satisfy these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Scope Integrity Rule:</strong> You must maintain the <strong>RD vs. Coach Gate</strong> (Module 13). Your portfolio must demonstrate guidance for performance, never medical nutrition therapy for disease.</li>
            <li><strong>The Evidence-Based Mandate:</strong> All nutritional "Solves" archived in your portfolio must remain anchored to the **SSoT (DGA 2025–2030)**. Professional credibility relies on traceability to established federal standards.</li>
            <li><strong>The Archival Rule:</strong> A "Resume" is a claim; a "Portfolio" is **EVIDENCE**. You must archive your specific mission plans (e.g., Module 15 Blueprint, Module 2 Lipid Swap) to prove clinical and technical competence.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Architect Note:</strong> In the professional market, your <strong>Solves</strong> are your currency. Protect your logic and you protect your career.
        </div>
    </section>
