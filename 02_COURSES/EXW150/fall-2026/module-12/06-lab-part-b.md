  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 12 - The Grocery Store Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Nutritional Equity</p>
    </header>

    <section id="access-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Social Solve</h3>
        <p>
            Your mission is to perform a **Resource Audit** of a local grocery source in a low-income Yuma zip code.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Audit a "Discount" or "Corner" store. Can a high-performance athlete meet their Macro/Micro rules using only this source?
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the specific "Food Desert" pattern of the store. What is the ratio of processed vs. fresh inventory?</li>
            <li><strong>The Rule:</strong> Use the <strong>Cost-per-Nutrient Rule</strong> to find one low-cost item (under ) that clears the <strong>Amino Acid Rule</strong> (Module 3).</li>
            <li><strong>The Solve:</strong> Based on the <strong>Cultural Mirror Rule</strong>, propose one "Heritage Food" item that fits into a high-performance plan without violating the DGA 2025-2030 standards.</li>
        </ol>
    </section>
