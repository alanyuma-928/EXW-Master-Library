  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Economic Reality
        </h2>
        <p style="font-weight: bold; color: #003366;">Understanding the "Nutritional Ceiling"</p>
    </header>

    <section id="access-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Sociological Filter</h3>
        <p>Your community nutritional strategy is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Cost-per-Nutrient Rule:</strong> In a resource-limited environment, success is measured by the nutrient density per dollar. Frozen and canned inventories (low cost) must be audited to ensure they meet the <strong>DGA Rule</strong> (Module 0).</li>
            <li><strong>The Cultural Mirror Rule:</strong> Nutritional "Solves" must respect the heritage and communal norms of the population. A plan that ignores the cultural importance of rice, beans, or specific spices is a "Professional Failure" due to zero adherence.</li>
            <li><strong>The Food Desert Mandate:</strong> Geographic distance to a full-service grocery store creates a "Nutritional Ceiling." If an athlete relies on a convenience store for inventory, the plan must shift from "Optimal" to "Harm Reduction."</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Yuma Reality:</strong> Many of our Matador students live in areas where fresh inventory is a 5-mile walk in the 110°F heat. Geography is a <strong>Redline</strong>.
        </div>
    </section>
