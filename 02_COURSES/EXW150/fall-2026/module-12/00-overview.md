  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 12: Social, Cultural, & Economic Factors
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Social Determinants" of Fueling</p>
    </header>

    <section id="system-access">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Access vs. Choice</h3>
        <p>
            Nutritional success is not just a matter of "Willpower"; it is a <strong>Pattern</strong> of access. Your socioeconomic status and geographic location dictate the inventory available to your engine. We shift from the "Biology" of previous modules into the <strong>Access</strong> of Module 12.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Socioeconomic Fueling Rules</strong>—learning how to solve for performance in a community with significant food deserts and cultural diversity.
        </p>
    </section>
