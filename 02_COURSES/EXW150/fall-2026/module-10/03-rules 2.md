  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Substrate Mix
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding "Mission-Specific Requirements"</p>
    </header>

    <section id="tailoring-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Bioenergetic Filter</h3>
        <p>Your sport-specific inventory is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Power Intensity Rule:</strong> High-explosive missions (Football, Powerlifting) are fueled by the Phosphagen and Glycolytic systems, requiring high-carbohydrate availability and peak protein doses for structural repair.</li>
            <li><strong>The Endurance Efficiency Rule:</strong> Long-duration missions (Cycling, Distance Running) require a higher reliance on Lipid Reservoirs (Module 2) and precision timing of exogenous Carbohydrates (Module 6) to prevent glycogen depletion.</li>
            <li><strong>The Intermittent/Team Rule:</strong> Stop-and-go sports (Soccer, Basketball) represent a hybrid demand, requiring a "Dual-Fuel" strategy of sustainment carbs and high-recovery protein pulses.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Tailoring Logic:</strong> The "Nutritional Dose" must be perfectly mapped to the <strong>Bioenergetic Output</strong> of the athlete's specific mission.
        </div>
    </section>
