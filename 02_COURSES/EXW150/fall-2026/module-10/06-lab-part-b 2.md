  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 10 - The Sport-Specific Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Bioenergetic Alignment</p>
    </header>

    <section id="tailoring-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Specificity Solve</h3>
        <p>
            Your mission is to perform a **Substrate Tailoring Audit** for two contrasting AWC athletes.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario 1:</strong> An 85kg Matador Offensive Lineman (Power/Force).
            <br>
            <strong>Scenario 2:</strong> A 60kg Matador Marathon Runner (Endurance/Efficiency).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the primary energy system (Phosphagen/Glycolytic or Oxidative) required for each athlete's mission.</li>
            <li><strong>The Rule:</strong> Use the <strong>Power Intensity</strong> or <strong>Endurance Efficiency</strong> rules to determine which macronutrient (Carbs or Fats) is the priority fuel for each.</li>
            <li><strong>The Solve:</strong> Propose one specific change to the "During" hydration window for the Runner that would not be required for the Lineman.</li>
        </ol>
    </section>
