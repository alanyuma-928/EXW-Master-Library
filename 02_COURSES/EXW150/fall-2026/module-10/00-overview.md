  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 10: Nutrition for Different Sports
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Bioenergetic Tailoring" Pattern</p>
    </header>

    <section id="system-specialization">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Metabolic Specificity</h3>
        <p>
            No two athletic missions are identical. Performance nutrition relies on a <strong>Pattern</strong> of specialization: a high-power mission (Sprint) requires different inventory than a long-duration mission (Marathon). We shift from the "Pathology" of Module 9 into the <strong>Specific Tailoring</strong> of Module 10.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Substrate Tailoring Rules</strong>—learning how to adjust your macros (Carbs, Fats, Proteins) to match the unique bioenergetic demands of any sport.
        </p>
    </section>
