  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 4: Micronutrients (The Metabolic Spark Plugs)
        </h2>
        <p style="font-weight: bold; color: #000080;">Igniting the Human Engine</p>
    </header>

    <section id="system-micros">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: The Metabolic Spark Plug</h3>
        <p>
            Vitamins and Minerals provide a high-stakes <strong>Pattern</strong>: they are the metabolic spark plugs that ignite your fuel (Macros) and repair your hardware (Protein). We shift from the "Bulk" of previous modules into the <strong>Precision</strong> of Module 4.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Mineral Density Rules</strong>—learning how micro-inventory facilitates every energetic and structural process in your body.
        </p>
    </section>
