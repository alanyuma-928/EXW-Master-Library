  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 04 - The Micro-Gap Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Metabolic Ignition</p>
    </header>

    <section id="micro-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Ignition Solve</h3>
        <p>
            Your mission is to perform a **Micro-Gap Audit** for a high-intensity endurance athlete.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> An athlete is meeting their Macro targets (Carbs/Fats) but reports chronic fatigue and poor recovery.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify one specific micronutrient (e.g., Iron or Vitamin D) that, if missing, would cause the "Fatigue Pattern" regardless of caloric intake.</li>
            <li><strong>The Rule:</strong> Use the <strong>Co-Enzyme Rule</strong> or the <strong>Mineral Density Gate</strong> to describe the role of this nutrient in performance.</li>
            <li><strong>The Solve:</strong> Propose one **Whole-Food Inventory** item that solves the gap for this nutrient while respecting the SSoT (RDA).</li>
        </ol>
    </section>
