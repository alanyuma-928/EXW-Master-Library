  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 03 - The Hardware Repair Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Tissue Synthesis</p>
    </header>

    <section id="protein-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Structural Solve</h3>
        <p>
            Your mission is to calculate the **Protein Dose** required for a specific high-intensity Mission.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> A 75kg AWC student-athlete (Matador) is training 5 days/week for heavy resistance and power.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the total body weight (kg) and activity level for this athlete.</li>
            <li><strong>The Rule:</strong> Use the <strong>Protein Dose Mandate</strong> (recommend using 1.6 - 2.0g/kg for this level) to calculate the daily grams of protein required.</li>
            <li><strong>The Solve:</strong> Propose a "Distribution Solve" (4 pulses) that ensures the athlete hits their total while respecting the <strong>Anabolic Window Rule</strong> (20-40g per dose).</li>
        </ol>
    </section>
