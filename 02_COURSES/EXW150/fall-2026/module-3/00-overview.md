  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 3: The Structural Hardware (Proteins)
        </h2>
        <p style="font-weight: bold; color: #003366;">Repairing the Movement Machine</p>
    </header>

    <section id="system-protein">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Hardware Repair</h3>
        <p>
            While Carbohydrates and Lipids provide the fuel, Protein provides the <strong>Hardware</strong>. Movement creates mechanical stress on the body; Protein is the <strong>Pattern</strong> of repair and remodeling that makes the "Levers and Pulleys" (Module 3 of EXW101) stronger.
        </p>
        <p>
            By the end of this module, you will master the <strong>Protein Dose Rules</strong>—understanding how to time and quantify your protein intake to optimize recovery and muscle synthesis.
        </p>
    </section>
