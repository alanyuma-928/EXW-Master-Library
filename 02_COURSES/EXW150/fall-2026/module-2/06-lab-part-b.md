  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 02 - The Saturated Fat Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Cardiovascular Integrity</p>
    </header>

    <section id="lipid-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Endurance Solve</h3>
        <p>
            Your mission is to perform a **Lipid Integrity Audit** of a single day's intake.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Review your 24-hour inventory. Filter for foods high in saturated fat (e.g., butter, fatty meats, fried foods).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the three primary sources of fat in your current inventory.</li>
            <li><strong>The Rule:</strong> Use the <strong>Saturated Fat Redline</strong> to calculate your current percentage of calories from saturated fat. (Formula: Saturated Fat Grams × 9 / Total Calories).</li>
            <li><strong>The Solve:</strong> If you are over the 10% redline, propose one "Lipid Swap" (e.g., Avocado for Butter) that provides an unsaturated alternative without sacrificing the "Endurance Reservoir."</li>
        </ol>
    </section>
