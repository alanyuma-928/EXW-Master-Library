  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 2: The Long-Duration Reservoir (Lipids)
        </h2>
        <p style="font-weight: bold; color: #003366;">Fueling for Endurance & Survival</p>
    </header>

    <section id="system-lipids">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Infinite Endurance</h3>
        <p>
            While Carbohydrates (Module 1) are your "High-Velocity" fuel, Lipids (Fats) represent an almost <strong>Infinite Pattern</strong> of energy. We shift from the explosive power of the sprint into the sustained endurance of the long-term mission.
        </p>
        <p>
            By the end of this module, you will master the <strong>Fat-Status Rules</strong>—understanding how to leverage lipids for endurance while respecting the cardiovascular redlines codified in your clinical courses.
        </p>
    </section>
