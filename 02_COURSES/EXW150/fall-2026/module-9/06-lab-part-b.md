  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 09 - The Red-Flag Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Athlete Safety</p>
    </header>

    <section id="ethics-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Identifying Solve</h3>
        <p>
            Your mission is to perform a **Security Audit** of a high-stakes athlete case study.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> An AWC cross-country runner reports high performance but is experiencing frequent stress fractures, irritability, and has stopped their menstrual cycle.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the three components of the <strong>Female Athlete Triad</strong> present in this scenario.</li>
            <li><strong>The Rule:</strong> Use the <strong>RED-S Indicators</strong> to explain why "irritability and stress fractures" are actually metabolic energy failure signals.</li>
            <li><strong>The Solve:</strong> Based on the <strong>Referral Gate</strong>, what is the specific next step for this coach or trainer?</li>
        </ol>
    </section>
