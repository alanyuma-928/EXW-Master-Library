  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 9: Disordered Eating & RED-S
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Behavioral Redlines" of Performance</p>
    </header>

    <section id="system-ethics">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Nutritional Distress</h3>
        <p>
            In the high-pressure world of performance, there is a dangerous <strong>Pattern</strong>: the transition from "Strategic Eating" to "Disordered Eating." We shift from the "Architecture" of Module 8 into the <strong>Diagnostics and Ethics</strong> of Module 9.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Red-Flag Identification Rules</strong>—learning how to spot the physiological and behavioral signals of energy deficiency before they lead to permanent clinical failure.
        </p>
    </section>
