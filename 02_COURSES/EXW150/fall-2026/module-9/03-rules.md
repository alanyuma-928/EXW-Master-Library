  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - RED-S & The Triad
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding the "Systemic Shutdown"</p>
    </header>

    <section id="ethics-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Clinical Filter</h3>
        <p>Your diagnostic awareness is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Female Athlete Triad Rule:</strong> The dangerous intersection of Low Energy Availability, Menstrual Dysfunction (Amenorrhea), and Low Bone Mineral Density (Osteoporosis).</li>
            <li><strong>The RED-S Indicators:</strong> Chronic fatigue, impaired immunity, recurring injuries, and irritability are not "toughness traits," but clinical red-flags of systemic energy shortage.</li>
            <li><strong>The Referral Gate:</strong> As a kinesiologist, your role is <strong>Identification and Referral</strong>. You are not a licensed psychologist or dietitian; if a student-athlete crosses these redlines, you must refer them to an eating disorder specialist.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Professional Ethics:</strong> "Winning" at the cost of the athlete's long-term health is a **Professional Failure**. Protecting the "Energy Availability" (Module 8) is your primary mandate.
        </div>
    </section>
