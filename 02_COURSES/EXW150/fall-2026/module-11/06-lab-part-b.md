  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 11 - The Thermal Hydration Mission
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Thermal Load</p>
    </header>

    <section id="environmental-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Adaptation Solve</h3>
        <p>
            Your mission is to architect a **Hydration & Electrolyte Plan** for a 3-hour outdoor training session in 110°F Yuma heat.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Athlete:</strong> 80kg Matador Runner. High sweat rate. Known to experience "Heat Cramps" (Electrolyte failure) during summer sessions.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the specific "Thermal Load" pattern. Why does 110°F create more heart rate strain than 75°F for the same power?</li>
            <li><strong>The Rule:</strong> Use the <strong>Electrolyte Adaptation Mandate</strong> to propose a specific "Pre-Loading" sodium dose before the athlete begins.</li>
            <li><strong>The Solve:</strong> Based on the <strong>Thermal Loading Rule</strong>, identify why the athlete requires 20-30% MORE Carbohydrates during this session compared to a winter session.</li>
        </ol>
    </section>
