  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Thermal Loading
        </h2>
        <p style="font-weight: bold; color: #000080;">Understanding the "Evaporative Redlines"</p>
    </header>

    <section id="thermal-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Environmental Filter</h3>
        <p>Your environmental fueling strategy is governed by these "Rules":</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Thermal Loading Rule:</strong> High heat (e.g., 105°F+ in Yuma) increases the body's reliance on Carbohydrates (Module 1) due to elevated heart rate and metabolic stress. You "Burn Brighter" in the heat.</li>
            <li><strong>The Electrolyte Adaptation Mandate:</strong> In extreme heat, the sodium concentration in sweat can lead to a systemic "Hydraulic Failure." The sodium floor must be raised (Pre-loading and During-loading) to maintain osmotic balance (Module 5).</li>
            <li><strong>The Cold-Weather Caloric Rule:</strong> Cold environments trigger the "Shivering Pattern," drastically increasing the caloric cost of maintenance. Lipids (Module 2) become the primary rule for long-term thermal survival.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Yuma Reality:</strong> For the Matador athlete, the "Heat Redline" is the primary mission. In July/August, the environmental stress can override your entire nutritional plan.
        </div>
    </section>
