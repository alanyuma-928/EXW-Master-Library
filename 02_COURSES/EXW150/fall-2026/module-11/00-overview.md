  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 11: Environmental Factors
        </h2>
        <p style="font-weight: bold; color: #000080;">The "Environmental Adaptation" Pattern</p>
    </header>

    <section id="system-environment">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Thermal & Atmospheric Stress</h3>
        <p>
            The rules of performance nutrition are not static; they shift based on <strong>Where</strong> the mission occurs. The human engine operates within an <strong>Environmental Adaptation Pattern</strong>, adjusting its fuel and fluid needs to survive heat, cold, and altitude.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Electrolyte Adaptation Rules</strong>—learning how to protect the athlete's internal "Cooling System" (Module 5) in the extreme thermal loads of Yuma.
        </p>
    </section>
