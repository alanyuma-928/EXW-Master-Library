  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 05 - The Sweat Rate Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Fluid Integrity</p>
    </header>

    <section id="sweat-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Hydraulic Solve</h3>
        <p>
            Your mission is to perform a **Sweat Rate Audit** to calculate your specific fluid needs.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Weigh yourself pre- and post-60 minutes of exercise. Record any fluid intake during the mission. 
            <br><br>
            <em>(Formula: Pre-weight - Post-weight + Fluid Ingested = Total Sweat Loss).</em>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify your total "Sweat Loss" (ounces) during the 60-minute mission.</li>
            <li><strong>The Rule:</strong> Use the <strong>2% Dehydration Redline</strong> to calculate your "Critical Loss" threshold (Total Weight × 0.02).</li>
            <li><strong>The Solve:</strong> If you are training for 2 hours in the Yuma August heat, how would your "Liquid Inventory" change to satisfy the <strong>Osmotic Balance Rule</strong>?</li>
        </ol>
    </section>
