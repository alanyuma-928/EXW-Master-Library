  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 5: Hydration & Fluid Dynamics
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Coolant and Lubricant" of Human Performance</p>
    </header>

    <section id="system-hydration">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Fluid Dynamics</h3>
        <p>
            The human body is an exquisite <strong>Pattern</strong> of fluid dynamics: water serves as the primary medium of transport (Module 5 of EXW101) and the critical "Coolant" for the metabolic engine. We shift from the "Spark Plugs" of Module 4 into the <strong>Liquid Inventory</strong> of Module 5.
        </p>
        <p>
            By the end of this module, you will master the <strong>Osmotic Balance Rules</strong>—understanding how to manage water and electrolytes to prevent the "Thermal Redline" of dehydration.
        </p>
    </section>
