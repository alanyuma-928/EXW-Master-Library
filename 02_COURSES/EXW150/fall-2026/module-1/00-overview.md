  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 1: The High-Velocity Fuel (Carbohydrates)
        </h2>
        <p style="font-weight: bold; color: #000080;">Fueling the Performance Engine</p>
    </header>

    <section id="system-carbs">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: High-Velocity Fuel</h3>
        <p>
            The human engine relies on a powerful <strong>Pattern</strong>: Carbohydrates are the primary, most efficient fuel source for high-intensity activity. We shift from the "Baseline" of Module 0 into the <strong>Specific Fueling</strong> of Module 1.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Glycemic Rules</strong>—learning how to time your carbohydrate intake to ensure maximum energy availability during the movement mission.
        </p>
    </section>
