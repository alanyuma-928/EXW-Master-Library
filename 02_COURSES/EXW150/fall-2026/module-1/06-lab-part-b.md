  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 01 - The Pre-Game Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Sustained Energy</p>
    </header>

    <section id="game-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Glycemic Solve</h3>
        <p>
            Your mission is to perform a **Pre-Game Nutritional Audit** for a 90-minute high-intensity soccer match.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> The athlete plans to eat a high-fiber salad with raw vegetables and a high-protein steak 30 minutes before the match.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe the "Glycemic Integrity" of the athlete's planned meal. How fast will the fuel release?</li>
            <li><strong>The Rule:</strong> Use the <strong>Glycemic Response Pattern</strong> to explain why high fiber/high protein 30 minutes prior might lead to a "Fueling Failure" during the match.</li>
            <li><strong>The Solve:</strong> Propose a revised "Pre-Game Solve" (e.g., a simple carbohydrate source) that aligns with the 30-minute window for high-intensity performance.</li>
        </ol>
    </section>
