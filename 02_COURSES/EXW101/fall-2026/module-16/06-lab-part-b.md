  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 16 - The Professional Identity Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Transition</p>
    </header>

    <section id="identity-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Reflection Solve</h3>
        <p>
            Your mission is to perform a **Professional Identity Audit** to close out the EXW101 mission.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Prepare your foundational artifacts for migration to your AWC Professional Portfolio.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the three most significant "Solves" you produced this semester.</li>
            <li><strong>The Rule:</strong> State the next professional certification or degree "Gate" you intend to pursue (Revisit Module 13).</li>
            <li><strong>The Solve:</strong> Write a 200-word "Professional Philosophy" statement. How does your mastery of the <strong>Mission Loop</strong> (Pattern | Rule | Solve) prepare you for the clinical challenges of the EXW 200-level sequence?</li>
        </ol>
    </section>
