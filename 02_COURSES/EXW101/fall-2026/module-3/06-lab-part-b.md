  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 03 - The Lever Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Mechanical Advantage</p>
    </header>

    <section id="lever-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Hardware Solve</h3>
        <p>
            Your mission is to perform a **Mechanical Audit** of common movements.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Identify the **Fulcrum**, the **Effort** (Muscle), and the **Resistance** (Weight) for the following:
            <ul style="margin-top: 15px;">
                <li><strong>Task A:</strong> Standing on your tiptoes (Calf Raise).</li>
                <li><strong>Task B:</strong> Lifting a coffee cup (Bicep Curl).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify where the Fulcrum, Effort, and Resistance are located for each task.</li>
            <li><strong>The Rule:</strong> Classify each task as a 1st, 2nd, or 3rd class lever.</li>
            <li><strong>The Solve:</strong> Which task is designed for "Strength" (lifting heavy) and which is designed for "Speed"? How does the lever class prove this?</li>
        </ol>
    </section>
