  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 3: The Skeletal & Muscular Framework
        </h2>
        <p style="font-weight: bold; color: #003366;">The Anatomical Chassis of Human Movement</p>
    </header>

    <section id="system-hardware">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Levers & Pulleys</h3>
        <p>
            The human body is an exquisite mechanical <strong>Pattern</strong>: a system of bones (levers) and muscles (pulleys) designed to create motion. We shift from the "Fuel" of Module 2 into the <strong>Hardware</strong> of Module 3.
        </p>
        <p>
            By the end of this module, you will master the <strong>Anatomical Rules</strong>—understanding how your joints and muscles work together to generate torque and overcome resistance.
        </p>
    </section>
