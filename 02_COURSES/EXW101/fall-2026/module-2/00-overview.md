  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 2: The Metabolic Engine
        </h2>
        <p style="font-weight: bold; color: #003366;">Bioenergetics of Human Movement</p>
    </header>

    <section id="system-physiology">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Fuel-to-Force</h3>
        <p>
            The human body presents a remarkable <strong>Pattern</strong>: the ability to convert chemical energy (ATP) into mechanical force. We shift from the city streets of Module 1 into the <strong>Cellular Engine</strong> of Module 2.
        </p>
        <p>
            By the end of this module, you will master the <strong>Metabolic Rules</strong>—understanding which "Fuel System" the body uses based on how fast and how long you choose to move.
        </p>
    </section>
