  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 02 - The Metabolic Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Energy Pathways</p>
    </header>

    <section id="metabolic-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Bioenergetic Solve</h3>
        <p>
            Your mission is to perform a **Metabolic Audit** of two distinct high-stakes movements.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Review the following movements and identify the primary "Energy Rule" (ATP-CP, Glycolytic, or Oxidative) powering the mission.
            <ul style="margin-top: 15px;">
                <li><strong>Scenario A:</strong> Sprinting to catch a bus (6-second maximal effort).</li>
                <li><strong>Scenario B:</strong> Walking across the AWC campus in Yuma heat (15-minute steady effort).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the duration and intensity of each scenario.</li>
            <li><strong>The Rule:</strong> Match each scenario to its primary energy system based on the SSoT in 03-rules.md.</li>
            <li><strong>The Solve:</strong> Which system would fail first if the "bus chase" lasted 5 minutes instead of 6 seconds? Why?</li>
        </ol>
    </section>
