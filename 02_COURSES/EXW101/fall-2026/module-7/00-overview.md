  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 7: Health, Wellness, & Weight Management
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Energy Balance" of Human Movement</p>
    </header>

    <section id="system-balance">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Metabolic Equilibrium</h3>
        <p>
            Weight management is governed by a simple but immutable <strong>Pattern</strong>: the balance between energy intake (food) and energy expenditure (movement). We shift from the "Inventory" of Module 6 into the <strong>Balance</strong> of Module 7.
        </p>
        <p>
            By the end of this module, you will master the <strong>Energy Balance Equation</strong>—understanding the math required to achieve long-term health and wellness.
        </p>
    </section>
