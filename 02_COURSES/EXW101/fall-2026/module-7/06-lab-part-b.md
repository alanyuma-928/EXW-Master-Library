  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 07 - The Energy Balance Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Weight Management</p>
    </header>

    <section id="balance-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Metabolic Solve</h3>
        <p>
            Your mission is to perform an **Energy Balance Audit** of a 1-week health mission.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Calculate the math required for a subject to lose 1 lb of fat in 7 days using a "Dual-Deficit" approach.
            <ul style="margin-top: 15px;">
                <li><strong>Target Deficit:</strong> 3,500 kcal/week.</li>
                <li><strong>Strategy:</strong> Reduce intake by 250 kcal/day and increase movement expenditure by 250 kcal/day.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the total daily deficit required to hit the 3,500 calorie rule in one week.</li>
            <li><strong>The Rule:</strong> Explain why a "Dual-Deficit" approach (diet + exercise) is superior to "Diet Only" for preserving muscle mass.</li>
            <li><strong>The Solve:</strong> If the subject wanted to lose 10 lbs, how many weeks would their mission last under the "Slow & Low" mandate?</li>
        </ol>
    </section>
