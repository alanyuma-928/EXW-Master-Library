  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 15 - The Yuma Wellness Blueprint
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Community-Level Inactivity</p>
    </header>

    <section id="capstone-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Final Solve</h3>
        <p>
            Your mission is to design a **Community Wellness Blueprint** for a specific Yuma population.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Select a target group (e.g., AWC Students, a local retirement community, or an industrial workplace in Yuma). Identify a major barrier to their PAGA adherence.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe the "Inactivity Pattern" of your target population. What is the primary "Social Determinant" (Module 12) holding them back?</li>
            <li><strong>The Rule:</strong> Which specific PAGA Guideline (Step-count, Strength-days, or Balance) are you targeting to solve?</li>
            <li><strong>The Solve:</strong> Propose one **Institutional Change** (not just an exercise class) that would make physical activity the "Default Choice" for this population. (e.g., policy change, environmental redesign, or workplace mandate).</li>
        </ol>
    </section>
