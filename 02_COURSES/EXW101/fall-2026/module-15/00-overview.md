  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 15: Course Capstone (Community Wellness Solve)
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Synthesis Pattern" Final Mission</p>
    </header>

    <section id="capstone-intro">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Target: Community Integration</h3>
        <p>
            Welcome to the <strong>Final Mission</strong>. You have spent 14 modules deconstructing the human system—from the cell (Module 2) to the city (Module 12). Your final task is to <strong>Synthesize</strong> this knowledge into a single community-wide intervention.
        </p>
        <p>
            In this capstone, you will act as a <strong>Wellness Architect</strong>. You will identify a specific inactivity pattern in the Yuma community and design a structural "Solve" using the rules of PAGA 2018.
        </p>
    </section>
