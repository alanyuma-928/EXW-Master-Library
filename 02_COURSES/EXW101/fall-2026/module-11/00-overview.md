  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 11: Special Populations (Inclusive Movement)
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Movement for All" Mission</p>
    </header>

    <section id="system-inclusion">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Universal Adaptability</h3>
        <p>
            Physical activity is a universal human right. However, every body presents a unique <strong>Pattern</strong> of capability. We shift from the general "Ages" of Module 10 into the <strong>Specific Conditions</strong> of Module 11.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Adaptive Rules</strong>—learning how to modify federal guidelines to ensure safety and effectiveness for individuals with chronic conditions or disabilities.
        </p>
    </section>
