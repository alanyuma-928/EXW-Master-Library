  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 11 - The Inclusive Mission Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Adaptive Movement</p>
    </header>

    <section id="inclusive-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Adaptive Solve</h3>
        <p>
            Your mission is to modify a standard walking mission for a subject with **Mild Exercise-Induced Asthma**.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> The subject wants to walk 30 minutes daily in Yuma, but gets "tight-chested" after 10 minutes of continuous effort.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the current limitation (Environmental or Physiological) for this subject.</li>
            <li><strong>The Rule:</strong> Use the <strong>Continuity Mandate</strong> to propose a schedule that hits the 30-minute target without triggering a "Crap" (Failure) pattern. (Hint: Think "Bout" timing).</li>
            <li><strong>The Solve:</strong> How would you use the <strong>Talk Test</strong> to ensure they aren't "Over-shooting" their lung capacity?</li>
        </ol>
    </section>
