  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 4: Neuromuscular Control & Coordination
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Software" of Human Movement</p>
    </header>

    <section id="system-neurology">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Command & Control</h3>
        <p>
            Movement is not just about muscle; it is about <strong>Communication</strong>. The human body presents a complex <strong>Pattern</strong> of electrical signals that travel from the brain to the muscles. We shift from the "Hardware" of Module 3 into the <strong>Software</strong> of Module 4.
        </p>
        <p>
            By the end of this module, you will master the <strong>Neuromuscular Rules</strong>—understanding how your brain "boots up" the motor units required to execute precise movements.
        </p>
    </section>
