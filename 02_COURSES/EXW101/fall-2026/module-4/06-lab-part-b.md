  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 04 - The Recruitment Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Neural Control</p>
    </header>

    <section id="recruitment-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Software Solve</h3>
        <p>
            Your mission is to perform a **Neural Recruitment Audit** of two distinct tasks.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Observe the effort required for the following:
            <ul style="margin-top: 15px;">
                <li><strong>Task A:</strong> Picking up a single pencil. (High Precision).</li>
                <li><strong>Task B:</strong> Lifting a heavy textbook or a gym weights. (High Power).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe the difference in "Feel" between Task A and Task B.</li>
            <li><strong>The Rule:</strong> Use the <strong>Size Principle</strong> to explain why your brain didn't "Max Out" recruitment for the pencil.</li>
            <li><strong>The Solve:</strong> If you tried to lift the pencil with the same neural intensity as the heavy book, what would happen? Use the <strong>Motor Unit Rule</strong> to justify your answer.</li>
        </ol>
    </section>
