  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 12: Social & Cultural Factors
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Social Solve" for Movement Patterns</p>
    </header>

    <section id="system-culture">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Cultural Context</h3>
        <p>
            Human movement does not happen in a vacuum. It is a social behavior shaped by a complex <strong>Pattern</strong> of heritage, socioeconomic status, and cultural norms. We shift from the "Conditions" of Module 11 into the <strong>Culture</strong> of Module 12.
        </p>
        <p>
            By the end of this module, you will master the <strong>Socioeconomic Rules</strong>—understanding how various social determinants of health influence the movement choices of the Yuma community.
        </p>
    </section>
