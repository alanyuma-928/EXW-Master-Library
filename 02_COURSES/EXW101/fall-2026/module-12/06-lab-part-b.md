  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 12 - The Social Barrier Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Cultural Disparities</p>
    </header>

    <section id="cultural-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Social Solve</h3>
        <p>
            Your mission is to perform a **Social Audit** of a specific community barrier in Yuma.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Audit a local "Activity Desert" (an area with no parks or sidewalks) or a "Food Desert" within the Yuma city limits.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe the specific area you audited. What is the current "Pattern" of movement (or inactivity) there?</li>
            <li><strong>The Rule:</strong> Identify which <strong>Social Determinant</strong> (Economic, Neighborhood, or Cultural) is the primary "Redline" in this area.</li>
            <li><strong>The Solve:</strong> Propose one "Cultural Solve" (e.g., a bilingual community walk or a portable sports clinic) that would address this specific social barrier.</li>
        </ol>
    </section>
