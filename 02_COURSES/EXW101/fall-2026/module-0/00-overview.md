  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 0: Mission Readiness
        </h2>
        <p style="font-weight: bold; color: #003366;">Welcome to the Science of Human Movement</p>
    </header>

    <section id="system-entry">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Target: Curriculum-as-Code</h3>
        <p>
            Welcome to <strong>EXW101: Concepts of Kinesiology</strong>. This is not a "Gym Class." This is a rigorous, research-grade exploration of human movement.
        </p>
        <p>
            In this course, we use a <strong>Curriculum-as-Code</strong> approach. Every assignment and lab is an "Audit" of the human system. You will learn to use the <strong>Mission Loop</strong> (Pattern | Rule | Solve) to navigate the complexities of health, sport, and society.
        </p>
    </section>
