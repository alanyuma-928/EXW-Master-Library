  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Mission Loop
        </h2>
        <p style="font-weight: bold; color: #003366;">SSoT: PAGA 2018 (2nd Ed) Rulebook</p>
    </header>

    <section id="mission-loop-intro">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Three-Step Filter</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Pattern:</strong> Identify the current state. (e.g., "75% of Americans do not meet activity guidelines").</li>
            <li><strong>The Rule:</strong> Apply the Single Source of Truth. (e.g., PAGA 2018 says "150 minutes of moderate activity per week").</li>
            <li><strong>The Solve:</strong> Design the intervention. (e.g., "Add a 10-minute walk thrice daily").</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #003366;">
            <strong>Architect Note:</strong> In EXW101, your "Rules" come from the <strong>Physical Activity Guidelines for Americans (PAGA)</strong>. Study them like a coder studies a language manual.
        </div>
    </section>
