  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 00 - The Personal Audit
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Establishing your Baseline</p>
    </header>

    <section id="personal-audit">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Baseline Solve</h3>
        <p>
            Your first mission is a **Self-Audit**. You cannot build movement for others until you can measure it in yourself.
        </p>

        <div style="background-color: #ffffff; padding: 25px; border: 2px solid #003366; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Review your last 7 days of physical activity. Compare your total "Vigorous" and "Moderate" minutes against the PAGA 2018 Rulebook.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> State your total weekly minutes of moderate-intensity activity.</li>
            <li><strong>The Rule:</strong> Quote the PAGA 2018 requirement for adults.</li>
            <li><strong>The Solve:</strong> Do you meet the Federal Rule? If not, what is your "1-minute" solve to move you closer to the baseline?</li>
        </ol>
    </section>
