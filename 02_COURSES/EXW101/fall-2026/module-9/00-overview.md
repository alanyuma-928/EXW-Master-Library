  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 9: Psychological Benefits & Brain Health
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Cognitive Spark" of Human Movement</p>
    </header>

    <section id="system-brain">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Movement as Brain Food</h3>
        <p>
            The human brain operates on a profound <strong>Pattern</strong>: it is a biological machine that thrives on the neurochemical signals produced by movement. We shift from the "Body" of Module 8 into the <strong>Mind</strong> of Module 9.
        </p>
        <p>
            By the end of this module, you will master the <strong>Mental Health Rules</strong>—understanding how physical activity acts as "Fertilizer" for your brain, improving memory, mood, and sleep.
        </p>
    </section>
