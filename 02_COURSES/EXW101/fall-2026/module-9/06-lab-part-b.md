  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 09 - The Cognitive Spark Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Mental Resilience</p>
    </header>

    <section id="cognitive-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Neuro-Solve</h3>
        <p>
            Your mission is to perform a **Cognitive Audit** of your mental state post-movement.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Engage in 20 minutes of moderate-to-vigorous aerobic activity (e.g., jogging or power walking). Immediately follow with a 10-minute focus task (e.g., reading a textbook or light studying).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe your mood and "Processing Speed" before vs. after the 20-minute mission.</li>
            <li><strong>The Rule:</strong> Use the <strong>BDNF Rule</strong> to explain why your focus might be sharper after movement.</li>
            <li><strong>The Solve:</strong> If a student has a high-stakes exam in Yuma, how would you design their "Pre-Exam Solve" (Activity + Timing) based on the neuro-rules?</li>
        </ol>
    </section>
