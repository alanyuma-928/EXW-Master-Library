  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 08 - The Risk Shield Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Long-Term Survival</p>
    </header>

    <section id="risk-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Clinical Solve</h3>
        <p>
            Your mission is to perform a **Risk Shield Audit** based on the PAGA 2018 guidelines.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Review your Personal Audit from Module 0. Compare your current activity level to the "Maximum Shield" threshold (150-300 minutes).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Based on your Module 0 data, identify which of the "Big Four" chronic diseases you are currently MOST protected against.</li>
            <li><strong>The Rule:</strong> Quote the specific PAGA 2018 benefit for either Cardiovascular Disease or Type 2 Diabetes.</li>
            <li><strong>The Solve:</strong> If you increased your "Dose" by only 30 minutes a week, what specific physiological mechanism (from 03-rules.md) would be enhanced first?</li>
        </ol>
    </section>
