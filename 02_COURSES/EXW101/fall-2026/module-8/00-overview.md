  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 8: The Health Benefits of Physical Activity
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Chronic Disease Shield" of Human Movement</p>
    </header>

    <section id="system-medicine">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Movement as Medicine</h3>
        <p>
            Human health is protected by a powerful <strong>Pattern</strong>: the consistent application of physical activity acts as a shield against chronic disease. We shift from the "Math" of Module 7 into the <strong>Medicine</strong> of Module 8.
        </p>
        <p>
            By the end of this module, you will understand the <strong>Prevention Rules</strong>—how movement interrupts the pathological development of Cardiovascular Disease, Diabetes, and Cancer.
        </p>
    </section>
