  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 06 - The Inventory Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Nutritional Integrity</p>
    </header>

    <section id="inventory-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Inventory Solve</h3>
        <p>
            Your mission is to perform an **Inventory Audit** of your current intake patterns.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Track your intake for a single 24-hour period. Compare your macronutrient balance against the 2025-2030 Dietary Guidelines.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify your total water intake (ounces) and your primary source of Carbohydrates for the mission.</li>
            <li><strong>The Rule:</strong> Quote the SSoT recommendation for "Added Sugars" per the 2025-2030 Guidelines.</li>
            <li><strong>The Solve:</strong> If you were preparing for a 5-mile hike in Yuma, how would your "Inventory" change to satisfy both the <strong>Carbohydrate Rule</strong> and the <strong>Hydration Gate</strong>?</li>
        </ol>
    </section>
