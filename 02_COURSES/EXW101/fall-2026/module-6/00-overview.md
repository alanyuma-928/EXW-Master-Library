  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 6: Foundations of Nutrition & Fueling
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Inventory & Intake" of Human Movement</p>
    </header>

    <section id="system-inventory">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Inventory & Intake</h3>
        <p>
            Human performance is governed by a fundamental <strong>Pattern</strong>: the strategic intake and storage of fuel. We shift from the "Delivery" of Module 5 into the <strong>Inventory</strong> of Module 6.
        </p>
        <p>
            By the end of this module, you will master the <strong>Dietary Rules</strong>—understanding how to stock the human engine with the macronutrients and hydration required to sustain the movement mission.
        </p>
    </section>
