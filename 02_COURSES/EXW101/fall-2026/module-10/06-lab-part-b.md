  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 10 - The Multi-Generational Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Family Health</p>
    </header>

    <section id="family-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Continuum Solve</h3>
        <p>
            Your mission is to perform a **Lifespan Audit** of three distinct "Life-Points."
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Audit the movement patterns of a hypothetical family in Yuma:
            <ul style="margin-top: 15px;">
                <li><strong>Point A:</strong> A 10-year-old child (Active Start).</li>
                <li><strong>Point B:</strong> A 40-year-old parent (Maintenance).</li>
                <li><strong>Point C:</strong> A 72-year-old grandparent (Independence).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Based on the 03-rules.md, which "Life-Point" has the highest VOLUME requirement for movement?</li>
            <li><strong>The Rule:</strong> Quote the specific PAGA mandate for Point C (72yo) that is not required for Point B (40yo).</li>
            <li><strong>The Solve:</strong> Propose one "Family Mission" (Activity) in Yuma that satisfies the rules for all three generations at once.</li>
        </ol>
    </section>
