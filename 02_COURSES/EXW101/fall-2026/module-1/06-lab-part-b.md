  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 01 - The Yuma Access Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Community Movement</p>
    </header>

    <section id="access-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Environmental Solve</h3>
        <p>
            Your mission is to perform a **Sociological Audit** of a 1-mile radius in your neighborhood.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Count the number of continuous sidewalks, public parks, and recreational facilities. Use the "Walk Score" logic to determine if the environment "Encourages" or "Penalizes" movement.
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Describe the "Walkability" of your 1-mile radius. (Is it safe? Is it connected?).</li>
            <li><strong>The Rule:</strong> How does your environment violate or support the "Access Mandate"?</li>
            <li><strong>The Solve:</strong> Propose one specific change (e.g., adding a bike lane or a cooling station) that would increase physical activity in your specific Yuma location.</li>
        </ol>
    </section>
