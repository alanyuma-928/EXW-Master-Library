  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 13: Health-Related Careers & Professionalism
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Professional Path" of Kinesiology</p>
    </header>

    <section id="system-career">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Professional Pathing</h3>
        <p>
            The field of Kinesiology is a vast and diverse <strong>Pattern</strong>: a collection of specialized paths from clinical rehabilitation to high-performance coaching. We shift from the "Community" of Module 12 into the <strong>Career</strong> of Module 13.
        </p>
        <p>
            By the end of this module, you will master the <strong>Certification Rules</strong>—understanding the educational and professional requirements for a successful career in the movement sciences.
        </p>
    </section>
