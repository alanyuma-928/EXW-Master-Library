  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 13 - The Career Roadmap Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Pathing</p>
    </header>

    <section id="career-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Professional Solve</h3>
        <p>
            Your mission is to perform a **Career Roadmap Audit** of your intended path in Kinesiology.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Research one specific career in Kinesiology (e.g., Physical Therapist, Strength Coach, or Wellness Coordinator).
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> State your intended career path. Does this require a graduate degree (Master's/Doctorate) or a Bachelor's degree?</li>
            <li><strong>The Rule:</strong> Identify the specific <strong>NCCA Certification</strong> or <strong>State License</strong> required to work in this field.</li>
            <li><strong>The Solve:</strong> Based on the <strong>Scope of Practice Rule</strong>, list one specific task you WOULD be allowed to do and one you WOULD NOT be allowed to do in this career.</li>
        </ol>
    </section>
