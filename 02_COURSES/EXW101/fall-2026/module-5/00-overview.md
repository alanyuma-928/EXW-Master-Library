  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 5: The Cardiorespiratory Pipeline
        </h2>
        <p style="font-weight: bold; color: #003366;">The "Pump and the Pipe" of Human Movement</p>
    </header>

    <section id="system-delivery">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Supply & Demand</h3>
        <p>
            Human sustainment is an exquisite <strong>Pattern</strong> of supply and demand: the ability of the heart (the pump) and the lungs to deliver oxygen to the working muscles. We shift from the "Command" of Module 4 into the <strong>Delivery</strong> of Module 5.
        </p>
        <p>
            By the end of this module, you will master the <strong>Cardiac Rules</strong>—understanding how your body manages the "Traffic Flow" of blood and oxygen during physical activity.
        </p>
    </section>
