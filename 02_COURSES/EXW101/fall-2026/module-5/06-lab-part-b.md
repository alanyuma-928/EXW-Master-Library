  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 05 - The Pump Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Delivery Efficiency</p>
    </header>

    <section id="pump-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Delivery Solve</h3>
        <p>
            Your mission is to perform a **Cardiac Audit** of your own "Pump" response to a change in demand.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Protocol:</strong> Measure your Heart Rate (HR) at the Radial artery for 60 seconds in two states:
            <ul style="margin-top: 15px;">
                <li><strong>State A:</strong> Rested (Sitting quietly for 5 minutes).</li>
                <li><strong>State B:</strong> Active (After 2 minutes of brisk walking or 20 jumping jacks).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify your Resting HR (A) and Active HR (B). Calculate the "Heart Rate Delta."</li>
            <li><strong>The Rule:</strong> Use the <strong>Cardiac Output Rule ( = HR \times SV$)</strong> to explain why your heart rate increased in State B.</li>
            <li><strong>The Solve:</strong> If your "Pipes" (arteries) were clogged, what would happen to the pressure required for the same State B activity?</li>
        </ol>
    </section>
