  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 14 - The Wearable Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Digital Precision</p>
    </header>

    <section id="wearable-audit">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Digital Solve</h3>
        <p>
            Your mission is to perform a **Digital Tech Audit** of a sample wearable device.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Scenario:</strong> Review the data from an Apple Watch or Fitbit (or a sample log). Common metrics include: Heart Rate, Steps, and "Caloric Burn."
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pattern:</strong> Identify the Heart Rate (HR) data for a single "Vigorous" bout. How did the tech capture the pattern?</li>
            <li><strong>The Rule:</strong> Use the <strong>Accuracy vs. Estimation Rule</strong> to explain why the "Caloric Burn" number on the watch might be 20-30% incorrect compared to clinical math (Module 7).</li>
            <li><strong>The Solve:</strong> If a client tells you "I burned 1,000 calories on my walk" because their watch said so, how would you use the <strong>AI-Centaur Handshake</strong> to correct their expectation while maintaining rapport?</li>
        </ol>
    </section>
