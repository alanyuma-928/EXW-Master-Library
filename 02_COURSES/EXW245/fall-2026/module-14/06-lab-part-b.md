  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 14 - The Macro-Cycle solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Cumulative Adaptation</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a **3-Month Macro-cycle** for an endurance athlete preparing for a local 10K event.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Logic: Cycle Selection</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Month 1 (Meso 1):</strong> Foundation & Aerobic Base (Continuous Training).</li>
                <li><strong>Month 2 (Meso 2):</strong> Muscular Endurance & Threshold Development (Intervals).</li>
                <li><strong>Month 3 (Meso 3):</strong> Peak Performance & Taper (Vigorous intensity / Low Volume).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Meso Audit:</strong> Justify your sequence of Meso-cycles. Why must "Base" precede "Peak Performance"?</li>
            <li><strong>The Periodization Solve:</strong> Identify one "Micro-cycle" within Month 2. Provide the FITT-VP breakdown for a single week of the Interval phase.</li>
        </ol>
    </section>
