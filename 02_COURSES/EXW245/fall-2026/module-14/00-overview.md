  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 14: Integrated Program Design (Periodization)
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Periodization Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Program Variation</h3>
        <p>
            Long-term athletic and health development follows a rhythmic <strong>Pattern</strong>: the strategic and organized variation of training stimulus to prevent stagnation and overtraining. We shift from "Workouts" to <strong>Periodization Cycles</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Meso-Cycle Rules</strong> and apply the <strong>Principle of Overload</strong> to design integrated, multi-month blueprints for success.
        </p>
    </section>
