  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Steady State & Safety Gates
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM 11/12th Edition CRF Standards</p>
    </header>

    <section id="crf-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Testing Audit</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Steady State Rule:</strong> Heart Rate (HR) must be stabilized within +/- 5 bpm between the 2nd and 3rd minute of each stage. If stability is not met, the stage must be extended by 1 minute.</li>
            <li><strong>The APMHR Safety Gate:</strong> Submaximal testing must be terminated once the subject reaches 85% of their Age-Predicted Maximum Heart Rate (220-age).</li>
            <li><strong>The RPE Mandate:</strong> Rating of Perceived Exertion (Borg 6-20 Scale) must be recorded at the end of every 3-minute stage to correlate subjective effort with HR data.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Immediate Termination:</strong> Missions must stop immediately if the subject presents with signs/symptoms (chest pain, wheezing, staggering gait) or if systolic blood pressure fails to rise with increasing intensity.
        </div>
    </section>
