  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 4: Cardiorespiratory Fitness (CRF) Testing
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the {2}$ max Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Aerobic Capacity</h3>
        <p>
            Cardiorespiratory fitness is the <strong>Gold Standard</strong> for predicting long-term health and cardiovascular disease risk. The <strong>Pattern</strong> involves the body's ability to transport and utilize oxygen during sustained physical activity.
        </p>
        <p>
            By the end of this module, you will merge the <strong>Screening Logic</strong> from Module 2 with the <strong>Lode Corival Setup</strong> from Module 1 to execute a submaximal {2}$ max prediction protocol.
        </p>
    </section>
