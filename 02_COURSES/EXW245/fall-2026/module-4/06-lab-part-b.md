  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 04 - The YMCA Submaximal Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Predicting Aerobic Success</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform the <strong>YMCA Submaximal Cycle Ergometer Test</strong> on a peer utilizing the Lode Corival in GY 116.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Logic: Benchmarks</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Cadence:</strong> 50 RPM (consistent with ACSM metabolic equations).</li>
                <li><strong>Workload:</strong> Determined by HR response to the initial 0.5 kg (25 Watt) resistance stage.</li>
                <li><strong>Data Points:</strong> HR (min 2, min 3), BP (min 2), RPE (min 3) for each stage.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Steady State Audit:</strong> Provide your HR data for Stage 2. Did your subject reach steady state? If not, how did you modify the "Mission cadence"?</li>
            <li><strong>The {2}$ max Solve:</strong> Graph the HR vs. Workload relationship and solve for the predicted {2}$ max using the multi-stage extrapolation method.</li>
        </ol>
    </section>
