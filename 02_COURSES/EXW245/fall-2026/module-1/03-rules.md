  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Lode Corival Technical Baseline
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: Research-Grade Calibration Standards</p>
    </header>

    <section id="technical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Precision Mandate</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Hyperbolic Rule:</strong> For submaximal testing, the Lode Corival must be set to "Hyperbolic" mode. This ensures that the Workload (Watts) remains constant regardless of the subject's pedaling speed (RPM).</li>
            <li><strong>The Calibration Gate:</strong> Every testing session must begin with a console zero-check. If the ergometer is not "leveled" and zeroed, the data is Redlined as invalid.</li>
            <li><strong>The Seat Height Factor:</strong> The seat must be adjusted so that at the bottom of the pedal stroke, the subject's knee retains 5-10 degrees of flexion to ensure safety and mechanical efficiency.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Architect Note:</strong> We are building a "Measurement Culture." In EXW245, a 1% error in calibration is a failure of the screening mission.
        </div>
    </section>
