  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            04: Lab Practical (Part A) - Metabolic Calculation Prep
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Calculated Efficacy</p>
    </header>

    <section id="digital-simulation">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target: Theoretical Watts</h3>
        <p>
            Before entering GY 116, you must verify the math behind the mission. Your task is to calculate the <strong>Power (Watts)</strong> required for a subject to achieve a specific {2}$ according to the ACSM metabolic equations for leg cycling.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <strong>Equation:</strong> {2} = 1.8(work rate) / (body mass) + 3.5 + 3.5$<br>
            <em>(Convert Watts to kgm/min: 1 Watt = 6.12 kgm/min)</em>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Math Audit:</strong> Solve for a 70kg subject needing a 3rd stage workload of 100 Watts. What is their relative {2}0</li>
            <li><strong>The Lode Defense:</strong> Explain why the Hyperbolic mode is superior to a friction-braked bike for this specific calculation.</li>
        </ol>
    </section>
