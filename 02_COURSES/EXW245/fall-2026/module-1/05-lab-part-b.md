  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            05: Lab Practical (Part B) - GY 116 Hardware Handshake
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: The Onsite Solve</p>
    </header>

    <section id="hardware-setup">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Target: Equipment Mastering</h3>
        <p>
            In the GY 116 lab, you will perform the initial setup on the <strong>Lode Corival</strong>. This protocol is mandatory for every testing mission in the Fall 2026 semester.
        </p>

        <div style="background-color: #ffffff; padding: 25px; border: 2px solid #003366; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #003366; margin-top: 0;">3-Point Setup Handshake</h4>
            <ol style="margin-bottom: 0;">
                <li><strong>Seat Height:</strong> Record the numerical value on the seat post.</li>
                <li><strong>Console Orientation:</strong> Ensure the display is angled for easy 15-second data collection.</li>
                <li><strong>Hyperbolic Lock:</strong> Confirm the ergometer mode is set to "Independent" (Hyperbolic).</li>
            </ol>
        </div>
    </section>
