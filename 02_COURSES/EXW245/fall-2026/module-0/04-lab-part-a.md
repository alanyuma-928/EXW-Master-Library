<!-- SOURCE: EXW245 Fall 2026 Template -->
<!--
...
<!--
  COURSE: EXW 245 Exercise Testing & Prescription
  MODULE: 0
  COMPONENT: Lab Part A
...
<div class="exw-container"
    ...
    <section>
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target Overview</h3>
        <p>[EXW 245 Chassis: Testing & Prescription Standards. Grounded in ACSM 11/12th Edition.]</p>
    </section>

    <!-- NAVIGATION -->
    <nav style="display: flex; justify-content: center; gap: 15px; margin-bottom: 30px; margin-top: 60px;">
        <a href="/courses/your-course-id/modules" style="background-color: #FFFDD0; color: #000080; border: 2px solid #000080; padding: 14px 28px; text-decoration: none; font-weight: bold; border-radius: 4px; text-align: center; min-width: 120px;">MODULES</a>
    </nav>
</div>
