  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 06 - The Mobility Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for ROM Accuracy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform a <strong>Sit-and-Reach</strong> test and a goniometric assessment of **Knee Flexion**.
        </p>
        ...
        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            ...
            <ul style="margin-bottom: 0;">
                <li><strong>Goniometry:</strong> Knee Flexion (Axis: Lateral Epicondyle of the Femur).</li>
                <li><strong>Sit-and-Reach:</strong> Best of two trials (Legs extended, reach held for 2 seconds).</li>
                <li><strong>Safety:</strong> Slow, controlled movement (no ballistic bouncing).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Fulcrum Audit:</strong> Identify the anatomical landmark you used as the fulcrum for the knee flexion test. How did you ensure the arms were aligned during the move?</li>
            <li><strong>The Warm-up Defense:</strong> Defend why you required your subject to cycle/walk for 5 minutes before the sit-and-reach test.</li>
        </ol>
    </section>
