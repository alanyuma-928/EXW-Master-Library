  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Goniometry Protocol
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM 11/12th Edition Flexibility Standards</p>
    </header>

    <section id="flexibility-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The ROM Audit</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Warm-up Mandate:</strong> No flexibility test should be performed "cold." A minimum of 5-10 minutes of light aerobic activity is required to increase tissue temperature and safety.</li>
            <li><strong>The Fulcrum Rule:</strong> The center of the goniometer (the fulcrum) must be placed exactly over the anatomical axis of rotation for the joint being measured.</li>
            <li><strong>The Arm Alignment:</strong> The stationary (proximal) arm must align with the midline of the body/limb, while the movement (distal) arm follows the anatomical midline of the moving segment.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Precision Gate:</strong> Goniometry is a "Visual Audit." If the student misses the fulcrum alignment, the ROM data is architecturally invalid.
        </div>
    </section>
