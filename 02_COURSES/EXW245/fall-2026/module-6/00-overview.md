  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 6: Flexibility & Range of Motion (ROM)
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Mobility Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Joint Mobility</h3>
        <p>
            Flexibility presents a critical <strong>Pattern</strong>: the ability of a joint or series of joints to move through a full, pain-free range of motion. Restrictions here often lead to compensatory movements and chronic musculoskeletal strain.
        </p>
        <p>
            By the end of this module, you will master the <strong>Anatomical Fulcrum Rules</strong> for goniometry and the <strong>Warm-up Mandate</strong> required for safe, high-fidelity ROM assessment.
        </p>
    </section>
