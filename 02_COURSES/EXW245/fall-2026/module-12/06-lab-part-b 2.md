  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 12 - The Lifespan Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Structural Transitions</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform a dual-audit for two distinct "Life-Cycle" clients.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Case Study A: Sarah (22-weeks Pregnant)</h4>
            <p>Sarah wants to continue her "Core Strength" routine that involves lying flat on her back for 15 minutes.</p>
            
            <h4 style="color: #000080;">Case Study B: Mr. Miller (82yo)</h4>
            <p>Wants to start walking, but has a history of stumbling. He is currently "Sedentary."</p>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Pregnancy Solve:</strong> How will you modify Sarah's "Core" routine to satisfy the Supine Position Rule? (Provide an alternative position).</li>
            <li><strong>The Longevity Audit:</strong> For Mr. Miller, justify why your initial prescription MUST include more than just "Walking" to prevent project failure (falls).</li>
        </ol>
    </section>
