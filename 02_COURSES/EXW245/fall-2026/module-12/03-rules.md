  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Lifespan Safety Gates
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM & PAGA 2018 Lifespan Standards</p>
    </header>

    <section id="lifespan-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Clinical Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Supine Position Rule (Pregnancy):</strong> After 16 weeks of gestation, exercise in the supine (lying on back) position is redlined to avoid <strong>Supine Hypotensive Syndrome</strong> (fetal weight compressing the vena cava).</li>
            <li><strong>The Relative intensity Rule (Aging):</strong> For older adults, intensity must be prescribed using a <strong>0-10 Relative RPE scale</strong> rather than absolute HRR formulas, ensuring the "Dose" matches their specific functional reserve.</li>
            <li><strong>The Multi-Component Mandate:</strong> Older adults must include balance and functional strength training (Sit-to-Stand/Gait) as a primary "Rule" alongside aerobic volume to prevent fall-related failure.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Safety Mandate:</strong> In pregnancy, "Activity-First" remains the rule, but thermal stress (Mod 11) is a high-stakes redline. Core temperature must remain below 102&deg;F.
        </div>
    </section>
