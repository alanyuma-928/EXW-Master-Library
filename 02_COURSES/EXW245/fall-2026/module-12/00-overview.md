  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 12: Special Populations (Pregnancy & Aging)
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Life-Cycle Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Physiological Transitions</h3>
        <p>
            Pregnancy and aging present distinct <strong>Patterns</strong> of physiological shift: the temporary, high-demand adaptations of gestation and the long-term, structural changes of senescence. In this module, we solve for the <strong>Continuum of Care</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Supine Hypotensive Syndrome</strong> rules and the <strong>Relative Intensity</strong> mandates required to safely prescribe exercise across the human lifespan.
        </p>
    </section>
