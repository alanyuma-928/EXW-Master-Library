  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The ACSM Decision Tree
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM 11/12th Edition Standards</p>
    </header>

    <section id="screening-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Screening Hierarchy</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Continuity Rule:</strong> Define "Regular Exercise" as at least 30 min of moderate intensity, 3 days/week, for the last 3 months. If they don't meet this, they enter the "Sedentary" branch.</li>
            <li><strong>The Signs/Symptoms Gate:</strong> Any individual presenting with chest pain, dizziness, or orthopnea is an automatic <strong>REDLINE</strong>. Mission Terminated until medical clearance is obtained.</li>
            <li><strong>The Known Disease Factor:</strong> Individuals with CV, Metabolic, or Renal disease who are asymptomatic and already active may continue at moderate intensity without new clearance.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Safety Mandate:</strong> We no longer screen for CVD risk factors (like age or high cholesterol) to determine clearance. We screen for <strong>Current Activity</strong> and <strong>Current Symptoms</strong>.
        </div>
    </section>
