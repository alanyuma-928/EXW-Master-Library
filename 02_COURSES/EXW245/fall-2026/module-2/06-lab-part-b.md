  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 02 - The Screening Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Designing the Safety Clearance</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to audit a new client's intake data and use the ACSM Decision Tree to determine their path.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Case Study: John D. (45yo)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Activity:</strong> Walks 20 min twice a week.</li>
                <li><strong>History:</strong> Type 2 Diabetes (Managed).</li>
                <li><strong>Symptoms:</strong> Occasional shortness of breath during light walking.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Activity Audit:</strong> Does John D. meet the ACSM definition of "Regularly Active"? (Explain your "why").</li>
            <li><strong>The Clearance Solve:</strong> Based on his symptoms, does John D. require medical clearance before starting a V02 Max test on the Lode Corival?</li>
        </ol>
    </section>
