  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 2: Pre-Participation Health Screening
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the ACSM Decision Tree</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Screening Redlines</h3>
        <p>
            Health screening presents a critical <strong>Pattern</strong>: identifying individuals at risk for cardiac events during exercise. The legacy "Doctor's Note for Everyone" approach has been replaced by the high-precision <strong>ACSM Pre-Participation Screening Algorithm</strong>.
        </p>
        <p>
            By the end of this module, you will master the "Active-vs-Sedentary" entry points and utilize clinical signs/symptoms to determine when a testing mission is "Go" or requires medical clearance.
        </p>
    </section>
