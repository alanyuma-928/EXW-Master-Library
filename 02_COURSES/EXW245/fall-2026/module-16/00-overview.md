  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 16: Professional Portfolio Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: The Career Readiness Pattern</p>
    </header>

    <section id="portfolio-intro">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target: Professional Transition</h3>
        <p>
            Welcome to the <strong>Exit Mission</strong>. In this module, you shift from being a "Clinical Technician" to a <strong>Professional Practitioner</strong>. You will audit your 15-module body of work and curate it into a career-ready portfolio.
        </p>
        <p>
            This portfolio serves as your "Proof of Mastery" for the Antigravity clinical logic, demonstrating your ability to navigate high-stakes exercise science in the Yuma community.
        </p>
    </section>
