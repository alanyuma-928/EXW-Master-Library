  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Artifact Integrity
        </h2>
        <p style="font-weight: bold; color: #000080;">Administrative Logic: SSoT Continuity</p>
    </header>

    <section id="artifact-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Integrity Mandate</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Artifact Integrity Rule:</strong> All professional portfolio items (Lode Corival data, 1-RM estimates, FITT-VP blueprints) must be sanitized and clearly labeled with the specific ACSM/PAGA version utilized.</li>
            <li><strong>The Continuity Guard:</strong> Professionals must establish a "Update Cycle." You are required to identify how you will monitor for ACSM/PAGA updates to ensure your Source of Truth (SSoT) never becomes legacy.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Professional Fact:</strong> A portfolio is a "Living Asset." It must showcase your ability to reconcile raw data with clinical safety gates.
        </div>
    </section>
