  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 16 - The Reflection Solve
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission: Defending the Clinical Logic</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Final Audit</h3>
        <p>Consolidate your clinical artifacts and answer the final professional prompt.</p>
        
        <div style="background-color: #ffffff; padding: 25px; border: 2px solid #003366; border-radius: 4px;">
            <strong>The Prompt:</strong> "How will you defend your clinical logic to a future supervisor or clinical director using the SSoT (ACSM/PAGA) established in this course?"
        </div>
    </section>

    <section id="submission-protocol">
        <h3 style="background-color: #ba0c2f; color: #ffffff; padding: 10px; font-weight: bold; text-align: center;">SUBMISSION TYPE: TEXT-ONLY</h3>
        <ol>
            <li><strong>The Portfolio Curation:</strong> List the four artifact categories (Screening, Testing, Programming, Legal) you have curated for your professional body of work.</li>
            <li><strong>The Defense:</strong> Provide your 2-paragraph "Architect’s Statement" defending your use of the SSoT for high-risk populations.</li>
        </ol>
    </section>
