  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 10: Clinical Populations (Cardiac & Metabolic)
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Clinical Redline</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: High-Risk Interaction</h3>
        <p>
            Working with clinical populations presents a high-stakes <strong>Pattern</strong>: the intersection of Coronary Artery Disease (CAD) and Type 2 Diabetes. In this module, we shift from general fitness to <strong>Clinical Risk Management</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Ischemic Threshold</strong> rules and the <strong>Hypoglycemia Safety Gate</strong> required to prescribe exercise for clients at the peak of physiological vulnerability.
        </p>
    </section>
