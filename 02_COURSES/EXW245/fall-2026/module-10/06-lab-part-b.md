  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 10 - The Clinical Prescription Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Multi-Morbid Stability</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a FITT-VP prescription for **Mr. Henderson (62yo)**.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Case Study: Mr. Henderson</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Diagnosis:</strong> CAD (Post-stent) + Type 2 Diabetes.</li>
                <li><strong>Clinical Test:</strong> Angina (chest pain) occurred at 135 bpm during a stress test.</li>
                <li><strong>Glucose:</strong> Pre-exercise check reads 85 mg/dL.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Ischemic Audit:</strong> Calculate Mr. Henderson's specific Target Heart Rate (THR) ceiling based on the "10-beat rule."</li>
            <li><strong>The Glucose Solve:</strong> Based on his 85 mg/dL reading, what is your mandatory intervention before he starts his warm-up?</li>
        </ol>
    </section>
