  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Unified SSoT
        </h2>
        <p style="font-weight: bold; color: #003366;">Final Clinical Audit: ACSM & PAGA Integration</p>
    </header>

    <section id="unified-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Hierarchy of Safety Gates</h3>
        <p>In the capstone, all specialized rules converge. You must apply the following hierarchy in your final solve:</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>Screening Gate (Mod 2):</strong> Is the mission "Go" or "Redline" (Referral)?</li>
            <li><strong>Ischemic & Glucose Gates (Mod 10):</strong> Establishing the safety ceilings for cardiac and metabolic comorbid cases.</li>
            <li><strong>Thermal & Atmospheric Gates (Mod 11):</strong> Overriding all intensity goals if Heat Index > 105&deg;F.</li>
            <li><strong>Periodization Mandate (Mod 14):</strong> Ensuring 10-20% progression safety and logical cycle sequencing.</li>
        </ul>
    </section>
