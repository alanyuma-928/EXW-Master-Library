  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 15 - The Master Capstone Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission: The AWC Faculty Trekker</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Case: Dr. Rodriguez (58yo)</h3>
        <p>Audit the following profile and design the final 6-month blueprint.</p>
        
        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px;">
            ###<br>
            <strong>Diagnoses:</strong> Type 2 Diabetes, Hypertension, BMI 32.<br>
            <strong>History:</strong> Recent exercise stress test showed Ischemic ST-depression at 142 bpm.<br>
            <strong>Objective:</strong> Participate in a charity hike in the Yuma foothills (October session). Currently Sedentary.<br>
            ###
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Clinical Audit:</strong> Establish the specific THR ceiling for Dr. Rodriguez. Does he require medical clearance before testing on the Lode Corival?</li>
            <li><strong>The 6-Month Macro-Cycle:</strong> Provide the 3 Meso-cycle objectives (e.g., Base, Strength, Specificity).</li>
            <li><strong>The Thermal Solve:</strong> How will you manage his October hike if the temp hits 104&deg;F?</li>
        </ol>
    </section>
