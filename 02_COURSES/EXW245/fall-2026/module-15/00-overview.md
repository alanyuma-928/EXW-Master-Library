  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 15: The Final Clinical Capstone
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: The Lead Architect Finale</p>
    </header>

    <section id="capstone-intro">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target: Integrated Mastery</h3>
        <p>
            Welcome to the <strong>Final Clinical Capstone</strong>. You are no longer a student; you are the <strong>Lead Architect</strong>. Your mission is to synthesize the entire EXW245 technical battery into a single, high-stakes clinical intervention.
        </p>
        <p>
            You will be tasked with auditing a complex, multi-morbid case study, designing a precision testing protocol on the <strong>Lode Corival</strong>, and architecting a 6-month periodized blueprint that respects the <strong>Yuma Thermal Redlines</strong>.
        </p>
    </section>
