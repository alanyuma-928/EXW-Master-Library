  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 7: Principles of Exercise Prescription
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the FITT-VP Framework</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Program Architecture</h3>
        <p>
            Exercise prescription presents the ultimate <strong>Pattern</strong>: the transition from raw assessment data (Modules 1-6) into a clinical movement mission. We shift from "Testing" to <strong>Prescribing</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>FITT-VP Framework</strong> and apply the <strong>Progression Mandate</strong> to ensure your prescriptions drive adaptation without triggering structural failure.
        </p>
    </section>
