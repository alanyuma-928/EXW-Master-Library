  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The FITT-VP Mandate
        </h2>
        <p style="font-weight: bold; color: #003366;">SSoT: ACSM 11/12th Edition Prescription Standards</p>
    </header>

    <section id="fitt-vp-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Architectural Audit</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The FITT-VP Rule:</strong> Every prescription must explicitly define Frequency, Intensity, Time, Type, Volume, and Progression. A missing "Letter" in the FITT-VP is a clinical failure.</li>
            <li><strong>The Progression Mandate:</strong> Aerobic volume should be increased by no more than 10-20% per week for the sedentary beginner (The "Slow & Low" Rule).</li>
            <li><strong>The Dose-Response Gate:</strong> 150-300 minutes of moderate activity (or 75-150 vigorous) is the absolute volume required for major health gains (PAGA 2018 Sync).</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #003366;">
            <strong>Decision Logic:</strong> We prescribe based on <strong>Individual Readiness</strong>. If a subject failed the Screening (Mod 2) or has low CRF (Mod 4), the "Intensity" rule must be adjusted toward the Relative RPE.
        </div>
    </section>
