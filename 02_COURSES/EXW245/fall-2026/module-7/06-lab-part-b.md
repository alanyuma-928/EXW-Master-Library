  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 07 - The FITT-VP Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Individual Adaptability</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a comprehensive 1-month exercise prescription for a hypothetical client utilizing the data points gathered in the previous labs.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template: Data Integration</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Baseline Data:</strong> BMI, %Fat (Mod 3), Estimated {2}$ max (Mod 4), 1-RM Strength (Mod 5).</li>
                <li><strong>Frequency:</strong> Days per week for Aerobic vs. Resistance.</li>
                <li><strong>Intensity:</strong> Target HR Range (Karvonen Method) and %1-RM.</li>
                <li><strong>Progression:</strong> How will you advance the workload in Week 3?</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The FITT-VP Audit:</strong> Break down your prescription using the FITT-VP letters. Defend your "Intensity" choice based on your client's CRF ranking.</li>
            <li><strong>The Progression Solve:</strong> Provide the specific 10% volume increase from Week 1 to Week 2. What metric (Time or Intensity) did you choose to adjust?</li>
        </ol>
    </section>
