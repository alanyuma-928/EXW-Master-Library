  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 13 - The Administrative Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Professional Integrity</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform a **Professional Audit** of a sample scenario involving a new staff member at a wellness facility.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Case Study: "Coach Kris"</h4>
            <p>During a consultation, Kris tells a client, "You have Grade 2 Obesity and your shoulder pain is likely Bursitis. You should take 500mg of Vitamin C daily to recover."</p>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Scope Audit:</strong> Identify three specific **Scope of Practice** violations Kris committed in the case study.</li>
            <li><strong>The Consent Solve:</strong> List the three mandatory components of an **Informed Consent** form that protect Kris from liability during subsequent testing.</li>
        </ol>
    </section>
