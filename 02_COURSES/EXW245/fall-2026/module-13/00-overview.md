  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 13: Legal & Professional Responsibilities
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Administrative Redline</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Liability & Litigation</h3>
        <p>
            Professional practice presents a high-stakes <strong>Pattern</strong>: the exposure to legal liability through negligence or overstepping boundaries. In this module, we shift from physiological safety to <strong>Legal & Professional Integrity</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Scope of Practice</strong> boundaries and the <strong>Informed Consent</strong> rules required to protect the clinical professional from structural legal failure.
        </p>
    </section>
