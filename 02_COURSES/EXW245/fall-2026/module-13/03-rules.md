  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Scope & Consent
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM & NCCA Professional Ethics</p>
    </header>

    <section id="legal-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Administrative Audit</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Scope of Practice Rule:</strong> Exercise professionals may prescribe and instruct movement but are strictly redlined from **Diagnosing** conditions or **Prescribing** medical nutritional therapy or supplements.</li>
            <li><strong>The Informed Consent Gate:</strong> Before any data collection or exercise begins, a signed Informed Consent form must be obtained. This document must explicitly state the **Purpose**, **Risks**, and **Confidentiality** of the testing program.</li>
            <li><strong>The Privacy Mandate (HIPAA):</strong> All client records, assessment data, and health history must be stored in a secure, encrypted environment. Identifiable data must not be shared without written authorization.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Warning:</strong> Failure to obtain Informed Consent prior to testing is a "Non-compliance" pattern that invalidates the legality of the entire session.
        </div>
    </section>
