  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 09 - The Adherence Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Behavioral Stability</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a weight management plan for a client in the <strong>Preparation Stage</strong> of change. Your solve must prioritize <strong>Specific Action Planning</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template: Mastery</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Caloric Goal:</strong> Target a 500 kcal/day deficit (3,500/week) through a 250 kcal reduction in intake and 250 kcal increase in expenditure.</li>
                <li><strong>Behavioral Strategy:</strong> Smart Goal setting (Specific, Measurable, etc.) and habit-stacking.</li>
                <li><strong>Volume Target:</strong> Gradual build to 250 minutes per week (PAGA/ACSM Weight Loss standard).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The TTM Audit:</strong> How did you ensure your prescription didn't "over-reach" your client's current stage of change?</li>
            <li><strong>The Metabolic Solve:</strong> Provide the specific 1-week timeline for your subject to achieve a 1 lb fat loss. Defend your mix of diet vs. exercise caloric deficits.</li>
        </ol>
    </section>
