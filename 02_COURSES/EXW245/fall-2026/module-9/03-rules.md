  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Energy Balance & TTM
        </h2>
        <p style="font-weight: bold; color: #000080;">SSoT: ACSM & PAGA Weight Management Standards</p>
    </header>

    <section id="behavioral-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Metabolic Audit</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The 3,500 kcal Rule:</strong> A deficit of 3,500 kcal is traditionally required to lose 1 lb of fat. However, modern caveats (metabolic adaptation) require a "Slow & Low" approach—targeting a loss of only 1-2 lbs per week.</li>
            <li><strong>The TTM Gate (Stages of Change):</strong> You must identify if the client is in Pre-contemplation, Contemplation, Preparation, Action, or Maintenance. Prescribing "Action" goals to a "Contemplation" client is a clinical failure.</li>
            <li><strong>The Volume Mandate (Weight Loss):</strong> For weight loss maintenance, PAGA/ACSM standards shift to high-volume targets: 250-300+ minutes per week of moderate activity.</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Critical Logic:</strong> Behavior overrides Bioenergetics. Without a "Solve" for the client's current stage of change, the most accurate metabolic prescription will fail.
        </div>
    </section>
