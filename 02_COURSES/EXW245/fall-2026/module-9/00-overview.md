  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 9: Weight Management & Behavior Change
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Adherence Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Metabolic Balance</h3>
        <p>
            Weight management presents a multifaceted <strong>Pattern</strong>: the intersection of energy balance (calories in vs. out) and the psychological stages of behavior change. Testing and prescription are only effective if the client adheres to the mission.
        </p>
        <p>
            By the end of this module, you will master the <strong>3,500 Calorie Rule</strong> and apply the <strong>Transtheoretical Model (TTM)</strong> to design recipes for long-term behavioral success.
        </p>
    </section>
