  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 5: Muscular Strength & Endurance
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Muscular Fitness Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Force Production</h3>
        <p>
            Muscular fitness presents a distinct <strong>Pattern</strong>: the ability of a muscle or muscle group to exert force (strength) and sustain activity (endurance). This is the primary driver of functional independence and metabolic health.
        </p>
        <p>
            By the end of this module, you will master the <strong>1-RM Estimation Math</strong> and the <strong>Anatomical Safety Gates</strong> required to audit muscular performance without the risks of maximal loading.
        </p>
    </section>
