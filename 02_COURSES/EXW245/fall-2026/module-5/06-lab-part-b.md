  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 05 - The Muscular Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Force Efficacy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform a submaximal endurance test (Push-up) and a 1-RM Bench Press estimation.
        </p>
        ...
        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            ...
            <ul style="margin-bottom: 0;">
                <li><strong>Strength:</strong> 1-RM Bench Press (Estimated). Calculate based on a 3-5 rep-max.</li>
                <li><strong>Endurance:</strong> ACSM Push-up Test (Max repetitions without rest, chin-to-mat).</li>
                <li><strong>Safety:</strong> Spotting required for Bench Press; "Abdominal Bracing" for Push-ups.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Estimation Audit:</strong> Provide your 1-RM calculation. How many reps did your subject complete, and what formula did you utilize?</li>
            <li><strong>The Anatomical Solve:</strong> Identify one common "Safety Redline" you observed during the push-up test (e.g., sagging core or partial ROM) and how it influenced the final count.</li>
        </ol>
    </section>
