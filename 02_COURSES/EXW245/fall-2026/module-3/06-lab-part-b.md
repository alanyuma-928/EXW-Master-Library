  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 03 - The Anthropometric Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Distribution Accuracy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to perform a 3-site skinfold assessment on a peer and calculate their Percent Body Fat using the Jackson-Pollock equations.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Logic: Site Selection</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Male Sites:</strong> Chest, Abdomen, Thigh.</li>
                <li><strong>Female Sites:</strong> Triceps, Suprailiac, Thigh.</li>
                <li><strong>Calculations:</strong> Sum of Skinfolds -> Body Density -> % Fat (Siri Equation).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Precision Audit:</strong> Justify your 3-site selection and provide the mean value for each site (confirming consistency within 2mm).</li>
            <li><strong>The SEE Defense:</strong> Explain the 3.5% Standard Error to your peer. Why represents a "Range" more accurate than a "Single Number"?</li>
        </ol>
    </section>
