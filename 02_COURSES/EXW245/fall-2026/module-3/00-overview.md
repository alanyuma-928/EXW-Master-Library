  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 3: Body Composition & Anthropometrics
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Anthropometric Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Mass Distribution</h3>
        <p>
            Body composition presents a significant <strong>Pattern</strong>: the distribution of fat vs. fat-free mass directly correlates with metabolic and cardiovascular risk. We shift from "Weight" to <strong>Composition</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Anatomical Site Accuracy</strong> required for skinfold testing and apply the <strong>SEE (Standard Error of Estimate)</strong> to interpret the validity of your data.
        </p>
    </section>
