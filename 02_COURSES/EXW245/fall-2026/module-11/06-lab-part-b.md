  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 11 - The Environmental Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Respiratory Integrity</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a FITT-VP prescription for **Ms. Thompson (55yo)**.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Case Study: Ms. Thompson</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Diagnosis:</strong> Moderate COPD + Exercise-Induced Asthma.</li>
                <li><strong>History:</strong> Experiences "Catching of Breath" at a brisk walk.</li>
                <li><strong>Environment:</strong> Yuma, August (Heat Index: 108&deg;F).</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Thermal Audit:</strong> Based on the 108&deg;F Heat Index, where will Ms. Thompson's training session take place? (Provide the SSoT justification).</li>
            <li><strong>The Pacing Solve:</strong> How will you use the 0-10 Dyspnea scale during her initial 150-minute aerobic build? What is her specific target range?</li>
        </ol>
    </section>
