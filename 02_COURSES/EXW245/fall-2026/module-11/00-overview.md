  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 11: Pulmonary & Environmental Safety
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Oxygen & Thermal Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Atmospheric Stress</h3>
        <p>
            Pulmonary and environmental factors present a dual <strong>Pattern</strong>: impaired gas exchange and thermal strain. In the Yuma environment, these patterns converge, creating a high-stakes challenge for both the lungs and the cardiovascular system.
        </p>
        <p>
            By the end of this module, you will master <strong>Dyspnea Pacing</strong> and the <strong>Heat Index Safety rules</strong> required to prescribe exercise for clients with COPD or Exercise-Induced Bronchospasm (EIB) in extreme climates.
        </p>
    </section>
