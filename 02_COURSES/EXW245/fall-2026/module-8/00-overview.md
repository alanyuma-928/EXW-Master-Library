  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 8: Aerobic & Resistance Programming
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Pacing & Loading Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Physiological Specificity</h3>
        <p>
            Programming presents a complex <strong>Pattern</strong>: matching the "Dose" (Exercise) to the intended "Response" (Adaptation). We shift from general FITT-VP principles to specific <strong>Aerobic Methods</strong> and <strong>Resistance Schemes</strong>.
        </p>
        <p>
            By the end of this module, you will master the <strong>Heart Rate Reserve (HRR) Math</strong> and the clinical <strong>Set/Rep Schemes</strong> required to drive specific hypertrophic, strength, or endurance adaptations.
        </p>
    </section>
