  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 08 - The Integrated Programming Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Metabolic & Structural Adaptation</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a specific **Lower-Body Split** that integrates aerobic intervals and resistance hypertrophy.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Logic: Specificity</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Aerobic:</strong> Cycling Intervals (HRR 60-70%). Use the Karvonen formula to set the target THR.</li>
                <li><strong>Resistance:</strong> Leg Press & Hamstring Curl (Hypertrophy Volume: 2 sets of 10-12 reps).</li>
                <li><strong>Safety:</strong> Controlled eccentric phase (3 seconds) to ensure muscle tension and joint safety.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The HRR Audit:</strong> Provide the Karvonen calculation for your subject (MHR 190, RHR 70). What is their specific THR range for 60-70% intensity?</li>
            <li><strong>The Hypertrophy Solve:</strong> Defend why you chose the 8-12 rep scheme over a 1-5 rep strength scheme for this specific mission.</li>
        </ol>
    </section>
