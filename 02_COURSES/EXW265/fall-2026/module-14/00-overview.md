  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 14: Chronic Kidney Disease (CKD)
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Dialysis Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Filtration Failure</h3>
        <p>
            Chronic Kidney Disease presents a high-stakes <strong>Pattern</strong>: systemic toxicity from filtration failure, fluid retention, and the physical exhaustion associated with hemodialysis. 
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018 CKD standards</strong> to integrate movement within the complex constraints of dialysis schedules and fluid management.
        </p>
    </section>
