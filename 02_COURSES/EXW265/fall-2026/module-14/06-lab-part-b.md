  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 14 - The Filtration Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Metabolic Stability</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a movement plan for a client with Stage 4 CKD. Your solve must prioritize <strong>Dialysis Syncing</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Renal)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Light aerobic (Walking) + High-repetition resistance.</li>
                <li><strong>Timing:</strong> Sessions scheduled on non-dialysis days to ensure peak energy availability.</li>
                <li><strong>Duration:</strong> Gradual build to 150 minutes, utilizing RPE 3-4 (Moderate).</li>
                <li><strong>Safety Check:</strong> Monitoring pre- and post-exercise BP and body weight to track fluid shifts.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Timing Audit:</strong> Justify why you chose to schedule exercise on an "Off-Day" rather than an "In-Center" day for this client.</li>
            <li><strong>The Fluid Solve:</strong> How will you manage the 1L/hr hydration rule in the context of a CKD client with strict fluid restrictions? (Conflict Resolution).</li>
        </ol>
    </section>
