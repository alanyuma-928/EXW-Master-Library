  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Dialysis Gate
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Renal Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Timing Rule:</strong> Exercise is generally safest when performed on non-dialysis days. If performing "Intra-dialytic" exercise, it should only occur during the first half of the session to prevent hypotension.</li>
            <li><strong>The Fluid Rule:</strong> Strict adherence to prescribed fluid restrictions is mandatory. Over-hydration in CKD can lead to cardiac strain during exercise.</li>
            <li><strong>Electrolyte Watch:</strong> Monitor for muscle cramping or cardiac irregularities, which may indicate potassium or sodium imbalances common in renal failure.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Redline Warning:</strong> Avoid exercise immediately following a dialysis session, as clients are often severely fatigued and at peak risk for orthostatic failure (fainting).
        </div>
    </section>
