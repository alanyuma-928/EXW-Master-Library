...
<div style="background-color: #FFF9F0; color: #003366; padding: 30px; border: 2px solid #003366; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #003366;">Mission Loop: Solve for Local Outcomes</p>
    </header>

    <!-- THE SOLVE -->
    <section id="the-solve">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Efficacy-Builder Plan</h3>
        <p>
        ...
        <div style="background-color: #eef4f8; padding: 25px; border: 2px solid #003366; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #003366; margin-top: 0;">Prescription Parameters</h4>
