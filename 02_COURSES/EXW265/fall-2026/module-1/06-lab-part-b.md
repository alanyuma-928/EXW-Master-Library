<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-1/06-lab-part-b.md -->
<!--
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 01 - The Clinical Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solve for Local Outcomes</p>
    </header>

    <!-- THE SOLVE -->
    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Efficacy-Builder Plan</h3>
        <p>
            Your final mission for Module 1 is to design a <strong>Starting Week</strong> plan for Mr. Hernandez. The goal is not "Performance"; the goal is <strong>Efficacy</strong>—proving to the client that they can move safely despite their chronic condition.
        </p>

        <div style="background-color: #eef4f8; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Parameters</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Light Walking (Climate-controlled environment).</li>
                <li><strong>Duration:</strong> 10-minute bouts (Accumulating to the PAGA goal over time).</li>
                <li><strong>Frequency:</strong> Daily (3-5 sessions per week to establish a routine).</li>
                <li><strong>Safety Check:</strong> Proper footwear audit for neuropathy protection.</li>
            </ul>
