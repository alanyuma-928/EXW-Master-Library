<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-1/05-lab-part-a.md -->
<!--
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            05: Lab 01 - The Clinical Rule Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Apply the SSoT Rules</p>
    </header>

    <!-- LAB INSTRUCTIONS -->
    <section id="lab-instructions">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Part A: Socratic Audit</h3>
        <p>
            Engage with the <strong>Socratic Tutor (AI Persona)</strong> to verify your clinical logic for Mr. Hernandez. You must grounding your audit in the <strong>PAGA 2018 Chapter 6</strong> standards.
        </p>

        <div style="background-color: #fff9db; padding: 20px; border: 1px solid #f59f00; margin: 25px 0;">
            <h4 style="color: #862e00; margin-top: 0;">Operational Mandate</h4>
            <p style="margin-bottom: 0;">
                You must explicitly cite the "Some is Better" rule when determining the initial intensity for Mr. Hernandez. Do not default to the legacy clearance requirement.
            </p>
