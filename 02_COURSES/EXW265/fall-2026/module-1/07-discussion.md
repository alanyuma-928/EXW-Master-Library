<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-1/07-discussion.md -->
<!--
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            07: Pilots' Lounge - The Metabolic Sync
        </h2>
        <p style="font-weight: bold; color: #000080;">Community Audit: Bridging the Inactivity Gap</p>
    </header>

    <!-- DISCUSSION OBJECTIVE -->
    <section id="discussion-objective">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target Analysis</h3>
        <p>
            In the <strong>Pilots' Lounge</strong>, we synchronize our clinical findings. Discuss your "Solve" for Mr. Hernandez. Specifically, how does your plan address the high-risk pattern of T2D while following the "Some is Better" rule?
        </p>
    </section>
    ...
    <section id="discussion-protocol">
        <h3 style="color: #000080;">Mission Protocol</h3>
        <p>Your post must follow the High-Fidelity Rhythm: <strong>Submission Type: Text-Only</strong>.</p>

        <div style="margin-top: 20px;">
            <p><strong>Initial Briefing (Thursday):</strong> Present your 10-minute efficacy-builder plan. Wrap the exercise duration and mode in <strong>### Triple-Hashes ###</strong>.</p>
            <p><strong>Peer Audit (Sunday):</strong> Review two colleague plans. Identify one safety gate they successfully applied (e.g., Neuropathy protection or Inactivity avoidance).</p>
