<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-1/04-cv-case-study.md -->
<!--
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            04: CV Case Study - The Metabolic Pattern
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Identify the Patient Pattern</p>
    </header>

    <!-- THE PATTERN -->
    <section id="case-study-pattern">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Target Case: Mr. Hernandez</h3>
        <p>
            Audit the following clinical pattern. Use the <strong>### Delimiter Protocol</strong> to identify the factors that will trigger our <strong>SSoT (PAGA 2018)</strong> rules.
        </p>
        
        <div style="background-color: #ffffff; padding: 25px; border: 2px solid #003366; border-radius: 4px; font-family: monospace; font-size: 1rem;">
            ###<br>
            <strong>Name:</strong> Ricardo Hernandez (Age: 62)<br>
            <strong>Diagnosis:</strong> Type 2 Diabetes, Stage 1 Hypertension (135/85 mmHg)<br>
            <strong>Physical Activity:</strong> Sedentary (Zero weekly sessions)<br>
            <strong>Symptoms:</strong> Occasional peripheral neuropathy in feet; decreased cardiorespiratory endurance.<br>
            ###
