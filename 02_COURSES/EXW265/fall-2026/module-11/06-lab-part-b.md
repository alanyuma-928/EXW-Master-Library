  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 11 - The Axial Loading Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Structural Integrity</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Bone-Loading</strong> program for a 65-year-old female with Osteopenia (low BMD). Your solve must prioritize <strong>Mechanical Strain</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Bone Health)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Weight-bearing aerobic (Walking/Jogging) + Progressive Resistance Training.</li>
                <li><strong>Protocol:</strong> Multi-directional movements (e.g., side-stepping) to vary the strain on the femoral neck.</li>
                <li><strong>Frequency:</strong> 150-300 min aerobic volume; 2 days high-intensity resistance.</li>
                <li><strong>Safety Check:</strong> Proper footwear to absorb excess impact while maintaining ground reaction forces.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Loading Audit:</strong> Explain why you chose walking over swimming for this specific client pattern.</li>
            <li><strong>The Axial Defense:</strong> Justify the use of resistance training (e.g., weighted squats) for spinal bone density.</li>
        </ol>
    </section>
