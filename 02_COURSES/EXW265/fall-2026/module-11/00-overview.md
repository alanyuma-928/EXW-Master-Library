  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 11: Osteoporosis & Bone Health
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Bone Density Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Bone Demineralization</h3>
        <p>
            Osteoporosis presents a "Silent Pattern": the gradual loss of bone mineral density (BMD) which often goes unnoticed until a fracture occurs. This pattern requires a clinical pivot from low-impact "Safety" to <strong>High-Impact "Loading"</strong>.
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018 Weight-Bearing Mandate</strong> to solve for fracture prevention through axial loading and resistance training.
        </p>
    </section>
