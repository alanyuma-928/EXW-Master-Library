  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Loading Mandate
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Bone Health Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Weight-Bearing Rule:</strong> Adults with osteoporosis should engage in weight-bearing aerobic activity (walking, jogging, stairs) to stimulate osteoblast activity.</li>
            <li><strong>The Resistance Mandate:</strong> Muscle-strengthening activities are critical and should involve all major muscle groups 2 or more days a week.</li>
            <li><strong>Safety Gate (Fracture Risk):</strong> Deep spinal flexion and extreme twisting should be avoided in clients with severe osteoporosis to prevent vertebral compression fractures.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Critical Logic:</strong> Non-weight bearing activities (swimming/cycling) are excellent for CV health but are a <strong>FAILURE</strong> for bone density maintenance.
        </div>
    </section>
