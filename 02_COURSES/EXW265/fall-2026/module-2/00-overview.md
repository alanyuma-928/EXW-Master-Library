...
<div class="exw-container"
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 2: The Diabetes Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Metabolic Health</p>
    </header>

    <section>
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target Overview</h3>
        <p>In this module, we dive deep into <strong>Type 2 Diabetes (T2D)</strong>. You will audit the metabolic pattern of insulin resistance and apply the PAGA 2018 rules to design a plan that prioritizes post-prandial glucose regulation.</p>
    </section>
