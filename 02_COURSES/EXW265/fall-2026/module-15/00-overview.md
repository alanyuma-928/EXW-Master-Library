  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 15: Cognitive Impairment & Alzheimer's
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Executive Function Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Cognitive Erosion</h3>
        <p>
            Cognitive Impairment presents the <strong>Pattern</strong> of losing executive function, memory, and spatial orientation. This is not just a physical challenge; it is a "Command and Control" failure that requires a unique clinical solve.
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018 standards</strong> to design movement programs that stimulate the brain while ensuring the physical safety of the client.
        </p>
    </section>
