  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Cognitive Guardrail
        </h2>
        <p style="font-weight: bold; color: #003366;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Safety for the Mind</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Supervision Mandate:</strong> Due to orientation failure and "wandering" patterns, exercise for clients with advanced Alzheimer's must always be supervised or performed in a secure environment.</li>
            <li><strong>Simple Cues Rule:</strong> Instructions must be broken down into single-step, clear commands to minimize cognitive load and frustration.</li>
            <li><strong>Multi-Sensory Guard:</strong> Use visual markers (e.g., colored floor tape) to provide spatial feedback where internal orientation fails.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #003366;">
            <strong>Webcognita Insight:</strong> We are solving for "Neuro-Preservation." Exercise is a potent driver of Brain-Derived Neurotrophic Factor (BDNF), helping to preserve the remaining executive function.
        </div>
    </section>
