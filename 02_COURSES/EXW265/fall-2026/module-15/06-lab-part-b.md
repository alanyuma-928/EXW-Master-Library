  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 15 - The Dual-Task Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Cognitive Stimulation</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Dual-Task Movement</strong> program for a client in the early stages of Alzheimer's. Your solve must prioritize <strong>Simultaneous Stimulation</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Cognitive)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Walking + Cognitive Task (e.g., naming objects, simple math, or following color cues).</li>
                <li><strong>Protocol:</strong> 150 minutes of aerobic activity, integrated with 2-3 sessions of dual-task balance drills.</li>
                <li><strong>Environment:</strong> Predetermined, distraction-free path to minimize orientation failure.</li>
                <li><strong>Safety Check:</strong> Monitoring for sudden agitation or "Sundowning" patterns during afternoon sessions.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Executive Audit:</strong> Describe the "Dual-Task" you will integrate into your client's walk and explain its neurological justification.</li>
            <li><strong>The Orientation Solve:</strong> How will you use the environment (visual cues) to ensure your client doesn't experience "Point A-to-Point B" failure?</li>
        </ol>
    </section>
