<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-0/04-centaur-protocol.md -->
<!--
...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #000080;">Professional Philosophy: Human Intuition + AI Precision</p>
    </header>

    <!-- PROTOCOL NARRATIVE -->
    <section id="centaur-philosophy">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Clinical Safety Gate</h3>
        <p>
            In <strong>EXW 265</strong>, working with special populations demands absolute precision. We utilize the
            <strong>Centaur Approach</strong>: a methodology where the human provides the clinical oversight and
            identifies contraindications (the "Head"), while the AI provides rapid auditing of clinical safety markers
            (the "Hooves").
        </p>
        <p>
            This <strong>Protocol</strong> ensures you maintain professional control over high-risk exercise
            prescriptions while utilizing AI as a high-fidelity secondary auditor.
        </p>
    </section>
    ...
    <!-- CORE RULES -->
    <section id="protocol-rules">
        <h3 style="color: #000080;">Rules of Engagement</h3>
        <p>Every interaction within this clinical space must adhere to these three standards:</p>

        <div
            style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-top: 20px;">
            <div style="background: #FFFDD0; padding: 20px; border: 1px solid #000080; border-radius: 4px;">
                <h4 style="color: #000080; margin-top: 0;">01. The Auditor</h4>
                <p style="font-size: 0.95rem;">You are the final <strong>Auditor</strong>. You are legally responsible
                    for client safety. You must audit every AI-generated suggestion against the <strong>SSoT (PAGA
                        2018)</strong>.</p>
