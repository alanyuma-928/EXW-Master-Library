<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-0/07-discussion.md -->
<!--
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Mission Loop 0: Establishing the Network
        </h2>
        <p style="font-weight: bold; color: #000080;">Orientation: Introductions &amp; Special Population Goals</p>
    </header>

    <!-- DISCUSSION OBJECTIVE -->
    <section id="discussion-objective">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Establishing the Network</h3>
        <p>
            Before we begin auditing clinical safety gates for high-risk populations, we must establish our professional
            network. In <strong>EXW 265</strong>, the <strong>Mission Loop Discussion</strong> serves as our orientation
            briefing. Use this space to introduce yourself and practice the technical protocols required for prescribing
    ...
    <!-- SUBMISSION PROTOCOL -->
    <section id="discussion-protocol">
        <h3 style="color: #000080;">Submission Protocol</h3>
        <p>To ensure high-fidelity communication from Day 1, your post must follow this specific two-phase rhythm. <strong>Submission Type: Text-Only</strong> (No attachments permitted).</p>

        <div style="margin-top: 20px;">
            <h4 style="color: #000080;">Part 1: The Initial Briefing (Due Thursday)</h4>
            <p>
                Provide a brief introduction including <strong>three interests</strong> related to chronic conditions or
                inclusive fitness and <strong>one specific goal</strong> you want to achieve this semester. You must
                wrap your introduction in <strong>triple-hashes (###)</strong> to demonstrate protocol readiness.
            </p>

            <h4 style="color: #000080;">Part 2: The Peer Audit (Due Sunday)</h4>
            <p>
                Respond to at least two of your colleagues. Find one common professional interest and welcome them to
                the mission. High-fidelity practitioners build networks; use this time to identify potential study
                partners for our <strong>PAGA Safety Audits</strong>.
            </p>
