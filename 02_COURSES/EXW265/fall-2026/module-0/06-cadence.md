<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-0/06-cadence.md -->
<!--
...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #000080;">Operational Rhythm: The Special Populations Scaffold</p>
    </header>

    <!-- MISSION RHYTHM -->
    <section id="rhythm-logic">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Mission Rhythm</h3>
        <p>
            To ensure clinical precision when working with high-risk populations, <strong>EXW 265</strong> operates on a
            standardized weekly <strong>Cadence</strong>. Each <strong>Module</strong> opens on <strong>Tuesday at 12:00
                AM</strong> and concludes the following <strong>Monday at 11:59 PM</strong>.
        </p>
        <div
            style="background-color: #eef4f8; padding: 20px; border: 1px solid #000080; border-radius: 4px; margin: 20px 0;">
            <p style="font-weight: bold; margin: 0;">
                SAFETY NOTE: Clinical audits require high cognitive load. It is recommended to complete Phase 1 (Files
                00-02) no later than Wednesday night.
            </p>
