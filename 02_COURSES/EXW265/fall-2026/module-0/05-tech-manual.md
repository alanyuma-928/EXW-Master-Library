<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-0/05-tech-manual.md -->
<!--
...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <!-- INTRO TO PERSONAS -->
    <section id="ai-personas">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The AI Learning Model</h3>
        <p>
            In the <strong>EXW Master Library</strong>, we utilize a custom AI Guided Learning model. Working with
            special populations requires absolute data integrity and safety gate adherence. You do not simply "chat"
            with a chatbot; you engage with three distinct professional personas designed to ensure your prescriptions
            are clinically safe.
        </p>
        ...
        <div
            ...
            <div style="background: #FFFDD0; padding: 20px; border: 1px solid #000080; border-radius: 4px;">
                <h4 style="color: #000080; margin-top: 0;">1. Socratic Tutor</h4>
                <p style="font-weight: bold; font-size: 0.8rem; color: #444; text-transform: uppercase;">Location: 04
                    Lab Part A</p>
                <p style="font-size: 0.9rem;">Your <strong>Clinical Assistant</strong>. This persona will not give you
                    answers. It will challenge your diagnosis-to-intensity logic and ensure your prescriptions for
                    high-risk clients align with the SSoT (PAGA 2018).</p>
