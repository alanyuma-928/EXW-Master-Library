<!-- SOURCE: 02_COURSES/EXW265/fall-2026/module-0/01-welcome.md -->
<!--
...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <div style="padding: 30px 40px;">
        ...
        <h3 style="color: rgba(39, 53, 64, 1);">What to Expect</h3>
        <ul>
            <li><strong>Clinical Scaffolding:</strong> We move through 5 distinct phases each week, from initial briefing to final inspection.</li>
            <li><strong>AI-Human Hybridization:</strong> You will learn to engineer prompts that drive safe, evidence-based results.</li>
            <li><strong>Workforce Ready:</strong> Everything we do mirrors the real-world documentation and audit standards of modern healthcare.</li>
        </ul>
    </div>
