  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 10: Healthy Aging & Longevity
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Sarcopenia Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Functional Decline</h3>
        <p>
            Healthy aging presents a predictable <strong>Pattern</strong>: loss of muscle mass (sarcopenia), reduced bone density, and a gradual decline in the ability to perform Activities of Daily Living (ADLs).
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018 Longevity Rules</strong> to design multi-component programs that prioritize functional independence and "Movement for Life."
        </p>
    </section>
