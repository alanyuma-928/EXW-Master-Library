  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 10 - The ADL Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Functional Autonomy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Multi-Component Functional</strong> program for an active 70-year-old. Your solve must prioritize <strong>Real-World Utility (ADLs)</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Longevity)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Resistance training (Bodyweight or Machines), Balance drills, and Walking.</li>
                <li><strong>Symmetry:</strong> Functional movements like Sit-to-Stand (Squat), Carry-Tasks (Farmer's Walk), and Stair Climbing.</li>
                <li><strong>Frequency:</strong> 3+ days of multi-component activity per week.</li>
                <li><strong>Safety Check:</strong> Proper hydration (The Yuma 1:1 Rule) and footwear audit.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Functional Audit:</strong> Identify how your "Sit-to-Stand" prescription directly solves for a real-world ADL (e.g., getting out of a car or a chair).</li>
            <li><strong>The Multi-Component Defense:</strong> Explain why you included a "Balance Drill" in an otherwise strength-focused routine.</li>
        </ol>
    </section>
