  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Multi-Component Mandate
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Longevity Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Multi-Component Rule:</strong> Older adults should do multi-component physical activity that includes balance training as well as aerobic and muscle-strengthening activities.</li>
            <li><strong>The Relative Intensity Rule:</strong> Intensity should be determined relative to the individual's level of fitness (RPE 5-6 is the target range for moderate longevity gains).</li>
            <li><strong>The "Move as Abilities Allow" Clause:</strong> When older adults cannot do 150 minutes of moderate-intensity aerobic activity, they should be as physically active as their abilities and conditions allow.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Critical Logic:</strong> We are solving for "Biological Youth." Can we slow the rate of functional loss through consistent, low-barrier movement?
        </div>
    </section>
