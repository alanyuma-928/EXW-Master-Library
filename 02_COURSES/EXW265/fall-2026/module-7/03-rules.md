  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Balance Mandate
        </h2>
        <p style="font-weight: bold; color: #003366;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">Neurological Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>Balance Rule:</strong> Multi-component physical activity that includes balance training and muscle strengthening is required for adults with neurological impairment.</li>
            <li><strong>The Fall Prevention Clause:</strong> All movements should be audited for fall risk; using external support (bars/walls) is a clinically sound Solve.</li>
            <li><strong>Aerobic Adaptation:</strong> Maintain 150 minutes of moderate activity, but duration may need to be split into shorter, frequent bursts to manage fatigue.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #003366;">
            <strong>Critical Logic:</strong> We are solving for "Survival Independence." Can the client move from Point A to Point B without a clinical fall?
        </div>
    </section>
