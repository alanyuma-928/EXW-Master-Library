  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 7: Neurological Disorders (Parkinson's)
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Neuro-Gait Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Motor Disruption</h3>
        <p>
            Neurological disorders like Parkinson's Disease present a unique <strong>Pattern</strong>: a breakdown in motor control, tremors, and gait instability. This is not just a "muscle" issue; it is a "signaling" issue.
        </p>
        <p>
            By the end of this module, you will pivot from purely metabolic goals to <strong>Proprioception</strong>, <strong>Balance</strong>, and <strong>Gait Stability</strong> using the PAGA 2018 Special Populations standards.
        </p>
    </section>
