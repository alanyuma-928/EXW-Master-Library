  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 07 - The Gait & Balance Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Motor Efficacy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Gait Stability</strong> program for a client with early-stage Parkinson's. Your solve must prioritize <strong>Proprioceptive Feedback</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Neurological)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Big-Movement Training (LSVT-style) or Tai Chi for balance.</li>
                <li><strong>Frequency:</strong> 2-3 sessions per week focused on balance + 150 min aerobic volume.</li>
                <li><strong>Safety Check:</strong> Clear the environment of trip hazards; utilize chairs for seated/standing transitions.</li>
                <li><strong>Cognitive Task:</strong> Integration of "Dual-Tasking" (e.g., walking while talking) once baseline stability is met.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Gait Audit:</strong> Identify the specific gait pattern disruption in your Parkinson's case (e.g., festination or shuffling).</li>
            <li><strong>The Balance Solve:</strong> Explain why balance training is more critical than "cardio speed" for this client's mission success.</li>
        </ol>
    </section>
