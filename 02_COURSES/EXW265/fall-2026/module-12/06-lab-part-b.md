  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 12 - The High-Intensity Balance Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Fall Resistance</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Fall-Recovery</strong> program for a client meeting the clinical criteria for Frailty. Your solve must prioritize <strong>Reactive Stability</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Frailty)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Weighted Sit-to-Stands (Power) + Tandem Walking (Balance) + 10-min Aerobic Interval.</li>
                <li><strong>Technique:</strong> Perturbation drills (light, controlled nudges or uneven surfaces) to train the "Recovery" response.</li>
                <li><strong>Safety Gate:</strong> Presence of a spotter or mechanical support during high-risk balance tasks.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Frailty Audit:</strong> Synthesize the client's muscle loss (Mod 10) and bone risk (Mod 11) into a single "Redline" safety statement.</li>
            <li><strong>The Balance Defense:</strong> Justify why "challenging" balance is necessary to prevent actual falls in the Yuma environment.</li>
        </ol>
    </section>
