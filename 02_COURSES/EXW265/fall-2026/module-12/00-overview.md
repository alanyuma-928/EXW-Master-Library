  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 12: Frailty & Fall Risk
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Navigating the Aging "Redline"</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Frailty Cascade</h3>
        <p>
            Frailty is the clinical "Redline" of the aging process—a state of increased vulnerability to stressors. The <strong>Pattern</strong> involves a synthesis of muscle loss (Sarcopenia), bone thinning (Osteoporosis), and impaired motor control (Neurological decline).
        </p>
        <p>
            By the end of this module, you will merge the clinical rules from the entire Aging block to design defensive <strong>Fall-Risk Interventions</strong> that preserve life and autonomy.
        </p>
    </section>
