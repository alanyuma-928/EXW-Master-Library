  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - The Stability Sovereignty
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Frailty Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Multi-Modal Mandate:</strong> Frail adults must engage in training that combines balance, strength, and aerobic work in every session.</li>
            <li><strong>The Challenge Rule:</strong> For balance training to be effective, it must be sufficiently challenging (perturbation training) while maintaining an absolute safety gate (spotting/bars).</li>
            <li><strong>The Continuity Clause:</strong> Exercise for frail adults should be performed 3 or more days per week to prevent "Deconditioning Drift."</li>
        </ul>
        
        <div style="background-color: #fefce8; padding: 20px; border-left: 5px solid #ca8a04;">
            <strong>Webcognita Insight:</strong> We are solving for "Survival Resilience." A single fall can trigger a terminal cascade; therefore, the <strong>Balance Rule</strong> overrides all "Cardio" goals.
        </div>
    </section>
