...
<div style="background-color: #FFFDD0; color: #000080; padding: 30px; border: 2px solid #000080; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Fatigue-Immunology Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Systemic Exhaustion</h3>
        <p>
            Cancer survivorship presents a complex <strong>Pattern</strong>: treatment-related fatigue, muscle wasting (cachexia), and an immunocompromised state. This is a mission that requires high-fidelity monitoring and adaptive pacing.
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018 Cancer Standards</strong> to design aerobic and resistance plans that reduce fatigue while respecting the client's current immunological status.
        </p>
    </section>
