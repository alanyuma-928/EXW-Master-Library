  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 13 - The Resilience Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Fatigue Management</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Paced Aerobic</strong> program for a client 3 months post-chemotherapy. Your solve must prioritize <strong>Energy Conservation</strong> while meeting the 150-minute volume goal.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Survivorship)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Walking or yoga (low-intensity to minimize systemic stress).</li>
                <li><strong>Protocol:</strong> Short 5-10 minute bouts spread throughout the day to prevent the "Crash Pattern."</li>
                <li><strong>Frequency:</strong> Daily light movement as tolerated.</li>
                <li><strong>Safety Check:</strong> Monitoring for signs of anemia or infection during activity sessions.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Fatigue Audit:</strong> Defend why you chose "Micro-Bouts" (5 min) instead of one continuous walk for this survivor.</li>
            <li><strong>The Immunological Solve:</strong> How did you modify the exercise environment to protect the client's compromised immune system?</li>
        </ol>
    </section>
