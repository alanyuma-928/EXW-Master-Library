  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Symptom-Guided Pacing
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Survivorship Guardrails</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Fatigue Rule:</strong> Intensity must be symptom-guided. If treatment fatigue is high, reduce volume and intensity rather than ceasing activity (Avoid Inactivity).</li>
            <li><strong>The Resistance Mandate:</strong> 2+ days a week to combat sarcopenia/cachexia induced by treatment.</li>
            <li><strong>Immunological Gate:</strong> Avoid high-traffic public gyms or swimming pools if the client is neutropenic (low white blood cell count).</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Webcognita Insight:</strong> We are solving for "Systemic Restoration." The goal is to build resilience in the "Host" (the client) during and after the battle with the disease.
        </div>
    </section>
