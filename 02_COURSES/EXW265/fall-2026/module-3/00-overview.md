...
<div class="exw-container"
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #000080;">Mission Loop: Sustained Metabolic Workrate</p>
    </header>

    <section>
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target Overview</h3>
        <p>In this unit, we audit the pattern of Obesity. You will apply the PAGA 2018 "Dose-Response" rule for weight management (300+ minutes) and solve for joint safety using low-impact modalities.</p>
    </section>
