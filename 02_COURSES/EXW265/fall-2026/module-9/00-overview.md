  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 9: Pulmonary Disorders (COPD)
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating the Dyspnea Pattern</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Gas Exchange Failure</h3>
        <p>
            Pulmonary disorders like COPD present a daunting <strong>Pattern</strong>: impaired gas exchange leading to Dyspnea (shortness of breath) and secondary anxiety. This often traps the client in a cycle of breathlessness and total inactivity.
        </p>
        <p>
            By the end of this module, you will pivot from "Motor Control" to <strong>Breath Management</strong>, utilizing the PAGA 2018 rules to design safe, effective pulmonary conditioning plans.
        </p>
    </section>
