  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 09 - The Dyspnea Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Solving for Pulmonary Efficiency</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a <strong>Pulmonary Conditioning</strong> program for a client with moderate COPD. Your solve must prioritize <strong>Interval Timing</strong>.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Pulmonary)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Walking or Cycling (Lower-body focus to minimize upper-body metabolic demand).</li>
                <li><strong>Intervals:</strong> 2-3 minutes of activity followed by 1-2 minutes of rest/diaphragmatic breathing.</li>
                <li><strong>Technique:</strong> Integration of "Pursed-Lip Breathing" during active bouts to manage CO2 retention.</li>
                <li><strong>Safety Check:</strong> Continuous SpO2 monitoring via pulse oximeter.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Dyspnea Audit:</strong> Explain how you will utilize the Borg 0-10 scale to ensure your client stays within the safe conditioning zone.</li>
            <li><strong>The Climate Solve:</strong> How does the Yuma environment (Heat/Dust) change your choice of exercise location for a COPD client?</li>
        </ol>
    </section>
