  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 05 - The Low-Impact Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Designing Joint-Safe Bouts</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design a movement plan for a client with Osteoarthritis who is currently sedentary. Your solve must prioritize <strong>Volume</strong> without triggering a <strong>Pain Gate</strong> response.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Low-Impact)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Swimming, Cycling, or Elliptical (Minimizing joint reaction forces).</li>
                <li><strong>Frequency:</strong> 3-5 sessions per week to meet PAGA Volume goals.</li>
                <li><strong>Intensity:</strong> RPE 3-4 (Moderate).</li>
                <li><strong>Safety Check:</strong> Proper warm-ups to "thaw" morning stiffness.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Audit:</strong> Distinguish between the discomfort your client *should* expect vs. the pain that necessitates stopping.</li>
            <li><strong>Einstein Defense:</strong> Defend why you chose a non-weight bearing modality (e.g., cycling) over walking for a joint-sensitive client.</li>
        </ol>
    </section>
