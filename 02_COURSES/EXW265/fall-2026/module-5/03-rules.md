  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Movement as Medicine
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Instructional Authority</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>Low Impact Rule:</strong> Adults with arthritis should engage in 150 minutes of moderate-intensity aerobic activity per week.</li>
            <li><strong>The Pain Scale Rule:</strong> Distinguish between "Good Discomfort" (Adaptation) and "Sharp Pain" (Injury). If pain is sharp or increasing, reduce intensity.</li>
            <li><strong>The Continuity Clause:</strong> Brief discomfort is common upon starting and is NOT a reason to cease activity; consistency is the primary driver of joint health.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Webcognita Insight:</strong> This "Pain-Audit" logic is a universal asset for auditing any high-stakes environment where distinguishing between "Stress" and "Failure" ensures safety.
        </div>
    </section>
