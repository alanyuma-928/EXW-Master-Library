  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #003366; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 5: The Arthritis Audit
        </h2>
        <p style="font-weight: bold; color: #003366;">Mission Loop: Breaking the Pain-Inactivity Cycle</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Pattern: Joint Sensitivity</h3>
        <p>
            Arthritis is the leading cause of disability in the U.S. The primary <strong>Pattern</strong> is joint pain and stiffness, which leads to a fear of movement, further weakening the joint structures and accelerating the disease.
        </p>
        <p>
            By the end of this module, you will use the <strong>SSoT (PAGA 2018)</strong> to solve for a client with arthritis by distinguishing between adaptive discomfort and sharp injury pain.
        </p>
    </section>
