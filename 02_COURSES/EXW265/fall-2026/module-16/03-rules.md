  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Resolving Rule Conflict
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Final Clinical Audit</p>
    </header>

    <section id="rule-conflict">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Hierarchy of Safety</h3>
        <p>In complex cases, rules often conflict. Your capstone requires you to apply the <strong>Hierarchy of Safety Gates</strong>:</p>
        <ul style="margin-bottom: 25px;">
            <li><strong>Thermal Gate (105&deg;F):</strong> Overrides all other goals. Permanent mission termination if environmental redlines are hit.</li>
            <li><strong>Oxygen Gate (90%):</strong> Overrides intensity goals. SpO2 stability is primary in pulmonary-comorbid cases.</li>
            <li><strong>Symptom-Guided Gate:</strong> Fatigue (Cancer/Neuro) and Pain (Arthritis) gates require real-time protocol shifts.</li>
        </ul>
        
        <div style="background-color: #fef2f2; padding: 20px; border-left: 5px solid #dc2626;">
            <strong>Redline Warning:</strong> Failure to identify a "Safety Gate" conflict in the final case study constitutes a clinical failure (Recalibrate status).
        </div>
    </section>
