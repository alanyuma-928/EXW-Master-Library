  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 16: Clinical Capstone Audit
        </h2>
        <p style="font-weight: bold; color: #000080;">Final Mission: The Multi-Morbid Solve</p>
    </header>

    <section id="capstone-intro">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Target: Clinical Mastery</h3>
        <p>
            Welcome to the <strong>Final Clinical Capstone</strong>. Throughout this course, you have studied specialized clinical "Blocks." Now, you must prove you can navigate the <strong>PAGA 2018 SSoT</strong> independently to solve for a client with multiple, conflicting chronic conditions.
        </p>
        <p>
            This is your final graduation from a "Student" to a <strong>Clinical AI Resident</strong>. You will be tasked with identifying patterns across metabolic, structural, and neurological systems to design a single, safe, high-efficacy movement mission.
        </p>
    </section>
