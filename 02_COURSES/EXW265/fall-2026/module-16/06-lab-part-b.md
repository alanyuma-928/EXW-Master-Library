...
<div style="background-color: #FFF9F0; color: #003366; padding: 30px; border: 2px solid #003366; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; max-width: 900px; margin: auto;">
  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #003366; margin-bottom: 30px; padding-bottom: 10px;">
        ...
        <p style="font-weight: bold; color: #003366;">Final Mission: Solving for Mrs. Gable</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #003366; border-left: 5px solid #003366; padding-left: 15px;">The Case: Mrs. Gable (78yo)</h3>
        <p>Audit the following multi-morbid pattern and design a single, consolidated 1-week movement plan.</p>
        
        <div style="background-color: #ffffff; padding: 25px; border: 2px solid #003366; border-radius: 4px;">
            ###<br>
