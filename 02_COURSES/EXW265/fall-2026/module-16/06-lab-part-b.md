  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 16 - The Capstone Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Final Mission: Solving for Mrs. Gable</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Case: Mrs. Gable (78yo)</h3>
        <p>Audit the following multi-morbid pattern and design a single, consolidated 1-week movement plan.</p>
        
        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px;">
            ###<br>
            <strong>Diagnoses:</strong> Osteoporosis (Severe), Type 2 Diabetes (Managed), Early-stage Alzheimer's, and Hypertension.<br>
            <strong>Pattern:</strong> Fear of falling (frailty), sedentary (0 min/week), morning stiffness.<br>
            <strong>Environment:</strong> Yuma (Summer session).<br>
            ###
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Multi-Morbid Audit:</strong> Identify the three most critical safety gates for Mrs. Gable.</li>
            <li><strong>The Integrated Solve:</strong> Design a 150-minute aerobic plan that simultaneously addresses her bone density (Loading) and her cognitive impairment (Visual Cues/Simple Tasks).</li>
            <li><strong>The Yuma Defense:</strong> Explain your thermal protocol for this multi-morbid client.</li>
        </ol>
    </section>
