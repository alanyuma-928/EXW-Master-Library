  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            Module 8: Stroke Recovery (Hemiparesis)
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Navigating Unilateral Deficits</p>
    </header>

    <section id="pattern-overview">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Pattern: Hemiparesis</h3>
        <p>
            Stroke recovery presents the <strong>Pattern</strong> of hemiparesis—weakness or paralysis on one side of the body. This creates a significant disruption in both balance and bilateral movement efficiency.
        </p>
        <p>
            By the end of this module, you will apply the <strong>PAGA 2018</strong> rules to solve for adaptive movement that restores functional independence while managing the risks of unilateral weakness.
        </p>
    </section>
