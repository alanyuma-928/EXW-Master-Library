  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            03: The Rules - Adaptive Stability
        </h2>
        <p style="font-weight: bold; color: #000080;">PAGA 2018 (2nd Ed) Clinical Audit</p>
    </header>

    <section id="clinical-rules">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">Operational Rules for Stroke</h3>
        <ul style="margin-bottom: 25px;">
            <li><strong>The Bilateral Rule:</strong> Even with unilateral weakness, training should involve both sides of the body to encourage neuroplasticity and prevent muscle atrophy on the affected side.</li>
            <li><strong>Safety Gate (Post-Stroke):</strong> Strict BP monitoring is required (as seen in Module 4) due to the high correlation between stroke and hypertension.</li>
            <li><strong>Adaptive Equipment:</strong> Use of hand-rests, straps, or recumbent positions (e.g., NuStep) is a mandated solve for clients with grip or balance failure.</li>
        </ul>
        
        <div style="background-color: #eef4f8; padding: 20px; border-left: 5px solid #000080;">
            <strong>Clinical Audit:</strong> We are solving for "Functional Symmetry." Can the client utilize their unaffected side to assist and retrain the affected side?
        </div>
    </section>
