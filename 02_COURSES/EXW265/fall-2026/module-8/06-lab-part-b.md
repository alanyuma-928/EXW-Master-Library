  ...
  <div class="module-content">
    ...
    <header style="border-bottom: 3px solid #000080; margin-bottom: 30px; padding-bottom: 10px;">
        <h2 style="color: #000080; margin: 0; font-size: 1.8rem; text-transform: uppercase; letter-spacing: 1px;">
            06: Lab 08 - The Hemiparesis Solve
        </h2>
        <p style="font-weight: bold; color: #000080;">Mission Loop: Designing for Adaptive Efficacy</p>
    </header>

    <section id="the-solve">
        <h3 style="color: #000080; border-left: 5px solid #000080; padding-left: 15px;">The Solve</h3>
        <p>
            Your mission is to design an <strong>Adaptive Aerobic</strong> program for a client 6 months post-stroke with left-side hemiparesis.
        </p>

        <div style="background-color: #FFFDD0; padding: 25px; border: 2px solid #000080; border-radius: 4px; margin: 25px 0;">
            <h4 style="color: #000080; margin-top: 0;">Prescription Template (Stroke Recovery)</h4>
            <ul style="margin-bottom: 0;">
                <li><strong>Mode:</strong> Recumbent Stepper (NuStep) or Adaptive Cycling.</li>
                <li><strong>Protocol:</strong> High-repetition, low-resistance movements to drive motor relearning.</li>
                <li><strong>Duration:</strong> Gradual build to 150 minutes, utilizing 10-minute bouts to manage central fatigue.</li>
                <li><strong>Safety Check:</strong> Ensure the unaffected limb is not overcompensating to the point of structural strain.</li>
            </ul>
        </div>
    </section>
    ...
    <section id="submission-protocol">
        ...
        <ol>
            <li><strong>The Unilateral Audit:</strong> Describe how you will stabilize the affected left side while utilizing the recumbent stepper.</li>
            <li><strong>The Neuro-Solve:</strong> Justify the use of high-repetition movement in the context of post-stroke neuroplasticity.</li>
        </ol>
    </section>
